package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2224:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_510,this.roomSessionEventHandler);
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_53.getValue(InventorySubCategory.const_327));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_53.getValue(InventoryCategory.const_867));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_53.getValue(InventoryCategory.const_275));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_53.getValue(InventorySubCategory.const_1115));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_53.getValue(InventoryCategory.const_130));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_53.getValue(InventoryCategory.const_430) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_510,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_377 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_53.add(InventoryCategory.const_430,_loc1_);
         ...
         this.var_53.add(InventoryCategory.const_275,_loc3_);
         ...
         this.var_53.add(InventoryCategory.const_867,_loc4_);
         ...
         this.var_53.add(InventorySubCategory.const_327,_loc6_);
         ...
         this.var_53.add(InventorySubCategory.const_1115,_loc7_);
         ...
         this.var_53.add(InventoryCategory.const_130,_loc8_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_965.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_965.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_965.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_965.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2224);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_797));
      }
      ...
      public function getItemById(param1:String, param2:int) : IItem
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc3_:Array = this.furniModel.include(param1);
         if(_loc3_ != null)
         {
            _loc4_ = 0;
