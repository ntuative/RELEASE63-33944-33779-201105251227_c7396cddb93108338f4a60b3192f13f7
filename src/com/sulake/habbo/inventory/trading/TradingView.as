package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1063:uint = 4284532064;
      
      private static const const_1064:uint = 2577770;
      ...
      private var var_637:ItemPopupCtrl;
      ...
      private var var_1001:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_637 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_210)
            {
               this.var_210.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_210.stop();
               this.var_210 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         if(this.var_73 == null)
         {
            this.var_73 = this.method_12();
         }
         if(this.var_1916 == null)
         {
            this.var_1916 = this.createMinimizedWindow();
         }
         if(!this.var_2669)
         {
            return this.var_73;
      ...
      private function method_12() : IWindowContainer
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc6_:int = 0;
      ...
      {
         return this.var_73.findChildByTag("OWN_USER_GRID") as IItemGridWindow;
      }
      
      protected function getOtherUsersItemGrid() : IItemGridWindow
      {
         return this.var_73.findChildByTag("OTHER_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateUserInterface() : void
      {
         ...
         {
            this.updateActionState();
            _loc2_ = this.var_73.findChildByTag("OTHER_USER_NAME") as ITextWindow;
            if(_loc2_)
            {
               _loc2_.text = this.var_20.otherUserName;
            }
            _loc1_ = this.var_73.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_1063) : uint(const_1064);
            }
            _loc3_ = this.var_73.findChildByTag("OWN_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
            ...
            _loc1_ = this.var_73.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_1063) : uint(const_1064);
            }
            _loc3_ = this.var_73.findChildByTag("OTHER_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               if(_loc3_.bitmap == null)
               {
      ...
      public function updateActionState() : void
      {
         ...
         if(this.var_73)
         {
            _loc1_ = this.var_73.findChildByName("button_accept");
            if(!_loc1_)
            {
               return;
            }
      ...
      {
         var _loc2_:ITextWindow = this.var_73.findChildByName("help_text") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
      }
      ...
      {
         var _loc2_:ITextWindow = this.var_73.findChildByName("info_text_0") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = this.var_73.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      {
         var _loc1_:ITextWindow = this.var_73.findChildByName("info_text_0") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = this.var_73.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_73.findChildByName("info_text_1") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = this.var_73.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc3_)
         {
            _loc3_.visible = false;
         }
      ...
      {
         var _loc1_:ITextWindow = this.var_73.findChildByName("info_text_1") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = this.var_73.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_210 = new Timer(1000,3);
            this.var_210.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_210.reset();
         this.var_210.repeatCount = 3;
         this.var_210.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_210.currentCount));
         if(this.var_210.currentCount == 3)
         {
      ...
      public function removeSelection() : void
      {
         if(this.var_1001)
         {
            this.var_1001.isSelected = false;
            this.var_1001 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1873)
            {
            ...
            this.var_637.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_584);
            this.var_637.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_637.hideDelayed();
         }
      }
         ...
         if(this.var_188.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_20.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_20.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_637.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_584);
               }
            }
            else
            {
