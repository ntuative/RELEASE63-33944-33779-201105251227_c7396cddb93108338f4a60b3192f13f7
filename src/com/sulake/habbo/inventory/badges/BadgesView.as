package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_70:BadgesModel;
      
      private var var_649:IItemGridWindow;
      
      private var var_1017:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_649 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_649.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onInactiveBadgeClick);
         this.var_1017 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1017.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onActiveBadgeClick);
      }
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Number = this.var_649.scrollV;
         this.var_649.removeGridItems();
         this.var_1017.removeGridItems();
         var _loc2_:Array = this.var_70.getBadges(BadgesModel.const_552);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(!_loc3_.isInUse)
            {
               this.var_649.addGridItem(_loc3_.window);
         ...
         if(_loc1_ > 0)
         {
            this.var_649.scrollV = _loc1_;
         }
         var _loc5_:Array = this.var_70.getBadges(BadgesModel.const_326);
         _loc4_ = 0;
         while(_loc4_ < _loc5_.length)
         {
            _loc3_ = _loc5_[_loc4_] as Badge;
            this.var_1017.addGridItem(_loc3_.window);
      ...
      public function updateActionView() : void
      {
         ...
         var _loc2_:Badge = this.var_70.getSelectedBadge();
         if(_loc2_ == null)
         {
            _loc1_.disable();
         ...
         else
         {
            ...
            this.setBadgeName(this.var_70.controller.localization.getBadgeName(_loc2_.type));
            this.setBadgeDescriptionText(this.var_70.controller.localization.getBadgeDesc(_loc2_.type));
            this.setBadgeDescriptionImage(_loc2_.iconImage);
            _loc3_ = this.var_70.getBadges(BadgesModel.const_326);
            if(_loc3_ != null && _loc3_.length >= this.var_70.getMaxActiveCount() && !_loc2_.isInUse)
            {
               _loc1_.disable();
            }
            else
      ...
      {
         var _loc2_:int = this.var_649.getGridItemIndex(param1.window);
         var _loc3_:Badge = this.var_70.getBadgeFromInactive(_loc2_);
         if(_loc3_ != null)
         {
            this.var_70.setBadgeSelected(_loc3_.type);
         }
      }
      
      private function onActiveBadgeClick(param1:WindowEvent) : void
      {
         var _loc2_:int = this.var_1017.getGridItemIndex(param1.window);
         var _loc3_:Badge = this.var_70.getBadgeFromActive(_loc2_);
         if(_loc3_ != null)
         {
            this.var_70.setBadgeSelected(_loc3_.type);
         }
      ...
      private function onWearBadgeClick(param1:WindowEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_70.toggleBadgeWearing(_loc2_.type);
         }
      }
   }
}
