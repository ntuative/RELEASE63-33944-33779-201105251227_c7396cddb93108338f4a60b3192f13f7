package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private var var_1717:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_414 = [];
         this.var_415 = [];
         this.var_592 = new Timer(const_1370,1);
         ...
         this.var_2331 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_148,this.onObjectPlaced);
               }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_39)
            {
               ...
               {
                  this.var_1717 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1717;
            }
            else
            {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_733 == null)
         {
            this.var_733 = this._windowManager.buildFromXML(this.var_2331) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_733.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_733.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_39,const_43];
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_.length)
         {
            _loc2_ = _loc4_[_loc5_];
            _loc1_ = this.include(_loc2_);
            if(_loc1_ != null)
            {
               _loc6_ = 0;
         ...
         if(param1 == InventoryCategory.const_74 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_43:
                  ...
                  break;
               case const_236:
                  this._controller.toggleInventoryPage(InventoryCategory.const_130);
            }
         }
      }
      ...
      {
         this.var_2330 = getTimer();
         this.switchCategory(const_236);
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_430);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_39,const_43];
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_.length)
         {
            _loc5_ = _loc7_[_loc8_];
            _loc4_ = this.include(_loc5_);
            if(_loc4_ != null)
            {
               _loc9_ = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_39,const_43];
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_.length)
         {
            _loc3_ = _loc5_[_loc6_];
            _loc2_ = this.include(_loc3_);
            if(_loc2_ != null)
            {
               _loc7_ = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_591.add(const_39,new Array());
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_39;
            _loc5_ = this.var_414.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_43;
            _loc5_ = this.var_415.indexOf(param1.ref) > -1;
         }
         var _loc8_:Array = this.include(_loc6_);
         if(!param1.groupable)
         {
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_236)
            {
      ...
      {
         return getTimer() < this.var_2330 + const_1369;
      }
      ...
      public function updatePostItCount(param1:int, param2:int) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc3_:Array = this.include(const_43);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function toggleItemSelection(param1:String, param2:int) : void
      {
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc3_:Array = this.include(param1);
      ...
      public function getSelectedItemIndex(param1:String = null) : int
      {
         ...
         var _loc2_:Array = this.include(param1);
         if(_loc2_ == null)
         {
            return -1;
         }
      ...
      public function getGroupItemInIndex(param1:int, param2:String = null) : GroupItem
      {
         ...
         var _loc3_:Array = this.include(param2);
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_327;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_311 || _loc3_.category == FurniCategory.const_347 || _loc3_.category == FurniCategory.const_319)
         {
            if(param1)
            {
               return false;
      ...
      public function include(param1:String) : Array
      {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_327:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_946)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      private function updateGroupItems(param1:String) : void
      {
         ...
         var _loc6_:Array = this.include(param1);
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_414.indexOf(_loc2_) == -1)
            {
               this.var_414.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_415.indexOf(_loc2_) == -1)
            {
               this.var_415.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            ...
            case UnseenItemCategoryEnum.const_380:
               return this.var_415.length;
            default:
               return this.var_414.length + this.var_415.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            case const_43:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_380));
                  this.var_415 = [];
                  _loc3_ = this.include(param1);
               }
               break;
            case const_39:
               if(this.var_414 && this.var_414.length > 0)
               {
