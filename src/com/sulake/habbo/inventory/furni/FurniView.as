package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1955:int = 0;
      ...
      private static const const_1042:int = 42;
      
      private static const const_1045:int = 120;
      ...
      private var var_70:FurniModel;
      
      private var var_782:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_368.add(FurniModelCategory.const_39,new FurniGridView(this.var_70,FurniModelCategory.const_39,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_368.add(FurniModelCategory.const_43,new FurniGridView(this.var_70,FurniModelCategory.const_43,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1043;
            _loc3_.y = _loc4_.y + const_1043;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         var _loc1_:Boolean = this.var_70.isTradingOpen;
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         if(this.var_70.isMainViewActive())
         {
            this.var_70.resetUnseenItems();
         }
         switch(param1)
         {
            case FurniModelCategory.const_43:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_wall"));
               this.var_429 = FurniModelCategory.const_43;
               break;
            case FurniModelCategory.const_39:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_floor"));
               this.var_429 = FurniModelCategory.const_39;
               break;
            case FurniModelCategory.const_236:
               _loc2_.setSelected(_loc2_.getSelectableByName("tab_pets"));
               this.var_429 = FurniModelCategory.const_236;
               break;
            default:
               throw new Error("Unknown item category: \"" + param1 + "\"");
         }
         this.var_70.furniCategorySwitch();
         this.showCategoryGrid(this.var_429);
         this.setViewToState();
      }
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_368.getValue(this.var_429);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_70.include(this.var_429);
         if(!this.var_70.isListInited())
         {
            _loc2_ = const_1044;
         }
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModelCategory.const_39,FurniModelCategory.const_43];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_368.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_368.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_368.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_368.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_70.getUnseenItemCount(UnseenItemCategoryEnum.const_439) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_70.getUnseenItemCount(UnseenItemCategoryEnum.const_380) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_pets");
         _loc1_.visible = this.var_70.petsModel.getUnseenItemCount() > 0;
      }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:int = this.var_70.getSelectedItemIndex();
         _loc4_ = this.var_70.getGroupItemInIndex(_loc3_,this.var_429);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_216);
         ...
         var _loc12_:Boolean = this.var_70.isTradingOpen;
         _loc11_ = this._view.findChildByName("placeinroom_btn") as IButtonWindow;
         if(_loc11_)
         {
            if(_loc1_ && this.var_70.isPrivateRoom)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc11_)
         {
            if(_loc1_ && _loc4_ != null && _loc5_ != null && this.var_70.canUserOfferToTrade())
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_782 && this.var_782.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1247)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1045)
         {
            _loc3_ = const_1045;
         }
         else if(_loc3_ < const_1042)
         {
            _loc3_ = const_1042;
         }
         else
      ...
      {
         var _loc3_:GroupItem = this.var_70.getGroupItemInIndex(this.var_70.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "placeinroom_btn":
                  this.var_70.requestSelectedFurniPlacement(false);
                  break;
               case "offertotrade_btn":
                  this.var_70.requestSelectedFurniToTrading();
                  break;
               case "sell_btn":
                  this.var_70.requestSelectedFurniSelling();
                  break;
               case "open_catalog_btn":
                  this.var_70.requestCatalogOpen();
                  break;
               default:
                  this.var_70.cancelFurniInMover();
            }
         }
         else if(param1.type == WindowEvent.const_50)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_236);
            }
         }
      }
