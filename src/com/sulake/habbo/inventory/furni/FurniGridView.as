package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_208 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      {
         var _loc3_:IWindow = this.var_208.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_208.autoArrangeItems = false;
            this.var_208.lock();
         }
         else
         {
            this.var_208.autoArrangeItems = true;
            this.var_208.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_70.toggleItemSelection(this._category,this.var_208.getGridItemIndex(param1.window));
            this.var_529 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_529 != null && this.var_529 == param2 && !this.var_70.isTradingOpen)
         {
            _loc3_ = this.var_70.requestSelectedFurniPlacement(true);
            if(_loc3_)
            {
               this.var_529 = null;
            }
         ...
         {
            this.var_70.requestCurrentActionOnSelection();
            this.var_529 = null;
         }
      }
   }
