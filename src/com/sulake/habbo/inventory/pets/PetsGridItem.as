package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_45:
               this.var_1471.setSelectedGridItem(this);
               this.var_1470 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1470 = false;
                  this.var_1471.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1469)
         {
            return;
         }
         this.var_1469.color = !!this.var_1441 ? uint(const_1400) : uint(const_1399);
         this.var_2387.visible = param1;
      }
