package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1044:int = 1;
      
      private const const_1041:int = 2;
      
      private const const_1046:int = 3;
      ...
      private var var_70:PetsModel;
      
      private var _disposed:Boolean = false;
      
      private var var_208:IItemGridWindow;
      ...
      private var var_221:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_208 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_221);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_527.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_208.removeGridItem(_loc2_.window);
         if(this.var_221 == _loc2_)
         {
            this.var_221 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_527 == null || this.var_527.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_527.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_527.getValue(param1.id) != null)
         {
            return;
         }
         var _loc2_:PetsGridItem = new PetsGridItem(this,param1,this._windowManager,this._assetLibrary,this._avatarRenderer,this.var_70.isUnseen(param1.id));
         if(_loc2_ != null)
         {
            this.var_208.addGridItem(_loc2_.window);
            this.var_527.add(param1.id,_loc2_);
      ...
      private function updateGrid() : void
      {
         ...
         this.var_208.removeGridItems();
         for each(_loc1_ in this.var_527)
         {
            _loc1_.dispose();
         }
         this.var_527.reset();
         _loc2_ = this.var_70.pets;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_221.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         this.var_70.placePetToRoom(param1,param2);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_50)
         {
            ...
            {
               case "tab_floor":
                  this.var_70.switchToFurnitureCategory(FurniModelCategory.const_39);
                  break;
               case "tab_wall":
                  this.var_70.switchToFurnitureCategory(FurniModelCategory.const_43);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_221 != null)
         {
            this.var_221.setSelected(false);
         }
         this.var_221 = param1;
         if(this.var_221 != null)
         {
            this.var_221.setSelected(true);
         }
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Map = this.var_70.pets;
         if(!this.var_70.isListInitialized())
         {
            _loc2_ = this.const_1044;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1041;
         }
         else
         {
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(this.var_70.roomSession != null)
         {
            _loc8_ = this.var_70.roomSession.arePetsAllowed;
            _loc9_ = this.var_70.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_70.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_439) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_70.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_380) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_pets");
         _loc1_.visible = this.var_70.getUnseenItemCount() > 0;
      }
   }
}
