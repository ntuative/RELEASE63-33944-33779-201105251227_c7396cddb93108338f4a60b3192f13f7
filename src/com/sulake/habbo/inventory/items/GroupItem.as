package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1399:int = 13421772;
      
      private static const const_1400:int = 10275685;
      ...
      protected var var_884:int = 0;
      
      protected var var_706:BitmapData;
      
      protected var var_2183:int;
      
      protected var var_1636:Boolean;
      ...
      private const const_1974:Number = 1;
      
      private const const_1973:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2387 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2166 == FurniModelCategory.const_39)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1404));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2159);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_946)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         this.var_1469.color = !!this.var_1530 ? uint(const_1400) : uint(const_1399);
         this.var_2387.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2165 && this.getRecyclableCount() > 0)
            {
