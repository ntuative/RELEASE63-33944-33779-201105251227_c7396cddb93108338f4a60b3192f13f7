package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_448:uint = 3;
      
      private static const const_1423:uint = 1;
      ...
      private var var_943:IWindowRenderer;
      
      private var _skinContainer:ISkinContainer;
      
      private var var_257:Array;
      
      private var var_1456:IEventDispatcher;
      
      private var var_1165:Boolean = false;
      
      private var var_1779:ProfilerOutput;
      
      private var var_1455:ProfilerAgentTask;
      
      private var var_1457:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_943 = new WindowRenderer(this._skinContainer);
         this._windowContextArray = new Array(const_448);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_448)
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_943,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_283 = this._windowContextArray[const_1423];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1779)
            {
               this.var_1779 = new ProfilerOutput(context,this,this.var_943);
            }
            this.var_1779.profiler = _loc3_;
            this.var_1455 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1455);
            this.var_1457 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1457);
            this.var_1165 = true;
         }
      }
      ...
      {
         return this.var_283.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_283.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_283.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_404.length > 0)
         {
            this.var_1456.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_448 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1456.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_448)
         {
         ...
         if(WindowContext.var_404.length > 0)
         {
            WindowContext.var_404.flush();
         }
         MouseCursorControl.change();
         this.var_1456.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1642,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1744,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1812,param2.name + ": " + param2.toString());
            }
         }
      }
