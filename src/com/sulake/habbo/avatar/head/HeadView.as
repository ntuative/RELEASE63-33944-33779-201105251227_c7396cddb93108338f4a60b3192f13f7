   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_70,FigureData.const_203,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_70,FigureData.const_252,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_70,FigureData.const_276,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_70,FigureData.const_239,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_70,FigureData.const_269,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_70 && var_151 == "")
         {
            var_70.switchCategory(FigureData.const_203);
         }
      }
