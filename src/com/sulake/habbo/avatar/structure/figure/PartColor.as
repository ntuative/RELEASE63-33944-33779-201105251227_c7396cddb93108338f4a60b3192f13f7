package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class PartColor implements IPartColor
   {
      ...
      public function PartColor(param1:XML)
      {
         ...
         this.var_2522 = parseInt(param1.@club);
         this.var_2449 = Boolean(parseInt(param1.@selectable));
         ...
         this.var_797 = new ColorTransform(this.var_2048,this.var_2049,this.var_2050);
      }
