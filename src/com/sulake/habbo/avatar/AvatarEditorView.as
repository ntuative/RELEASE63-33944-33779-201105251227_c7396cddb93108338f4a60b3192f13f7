package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1347:IWindowContainer;
      
      public static var var_1625:IWindowContainer;
      
      public static var var_2124:int = 6710886;
      ...
      private var var_385:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_539:IFrameWindow;
      
      private var var_450:Timer;
      
      private var var_2740:Number = 0;
      
      private var var_2741:Boolean = true;
      
      private var var_1980:String;
      
      private var var_2739:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1273 = [];
         this.var_1443 = [AvatarEditorFigureCategory.const_919,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_259,AvatarEditorFigureCategory.const_747,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_111];
         super();
         ...
         if(var_1347 == null)
         {
            ...
            var_1347 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1625 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1625 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_450 = new Timer(1000);
         this.var_450.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1443;
         }
         for each(_loc6_ in param4)
         {
            this.var_1273.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_450.stop();
            this.var_450.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_450 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1443);
         }
         if(param1.length != this.var_1273.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1273.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2741 = this.canChangeOutfit();
            this.var_450.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_385 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_385.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_385.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1273.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_385.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_385.numSelectables)
               {
                  this.var_385.getSelectableAt(_loc6_).x = this.var_385.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_385.setSelected(this.var_385.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1443;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_42) && (this.var_1980 == AvatarEditorSideCategory.const_111 || this.var_2739))
         {
         ...
         this.setViewToCategory(this.var_381);
      }
      ...
      {
         if(this.var_1980 == AvatarEditorSideCategory.const_111)
         {
            this.var_2739 = false;
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_940:
               break;
            case AvatarEditorSideCategory.const_558:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_558);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_381 = param1;
         this.var_385.setSelected(this.var_385.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2740 = new Date().valueOf();
                  this.var_2741 = false;
                  this.var_450.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_539)
         {
            ...
            this.var_539 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_539.procedure = this.stripClubDialogEventProc;
            this.var_539.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2740 > 5000;
      }
   }
}
