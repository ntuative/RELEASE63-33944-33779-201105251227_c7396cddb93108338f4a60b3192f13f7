   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_70,FigureData.const_255,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_70,FigureData.const_199,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_70,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_70,FigureData.const_237,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_70 && var_151 == "")
         {
            var_70.switchCategory(FigureData.const_199);
         }
      }
