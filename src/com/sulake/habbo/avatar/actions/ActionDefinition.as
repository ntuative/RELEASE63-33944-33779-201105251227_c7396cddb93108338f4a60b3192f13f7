package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_2074:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2074 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2867 = parseInt(param1.@precedence);
         this.var_2869 = String(param1.@activepartset);
         this.var_2864 = String(param1.@assetpartdefinition);
         this.var_2868 = String(param1.@lay);
         this.var_725 = String(param1.@geometrytype);
         this.var_2727 = Boolean(parseInt(param1.@main));
         this.var_2865 = Boolean(parseInt(param1.@method_12));
         this.var_2870 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2866 = _loc6_;
            }
            else
            {
               this.var_2074[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_863.getValue(param1) == null)
         {
            this.var_863.add(param1,new Map());
         }
         var _loc4_:Map = this.var_863.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_863.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_2074[param1];
         if(_loc2_ == null)
         {
