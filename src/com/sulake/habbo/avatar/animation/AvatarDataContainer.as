package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2048:Number = 1.0;
      
      private var var_2049:Number = 1.0;
      ...
      private var var_2871:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_2082 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2873 = parseInt(_loc2_,16);
         this.var_2872 = parseInt(_loc3_,16);
         this._rgb = parseInt(_loc2_,16);
         this.var_1704 = this._rgb >> 16 & 255;
         this.var_1705 = this._rgb >> 8 & 255;
         this._b = this._rgb >> 0 & 255;
         this.var_2048 = this.var_1704 / 255 * 1;
         this.var_2049 = this.var_1705 / 255 * 1;
         this.var_2050 = this._b / 255 * 1;
         if(this.var_2082 == 37)
         {
            this._alphaMultiplier = 0.5;
            this.var_2871 = false;
         }
         this.var_797 = new ColorTransform(this.var_2048,this.var_2049,this.var_2050,this._alphaMultiplier);
         this.var_1331 = this.method_14(this.var_2872,this.var_2873);
      }
      ...
      {
         return this.var_1331.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1331.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1331.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1331.getValue("alphas") as Array;
      }
      ...
      private function method_14(param1:uint, param2:uint) : Map
      {
