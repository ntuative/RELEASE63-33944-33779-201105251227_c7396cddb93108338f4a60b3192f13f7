package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_2254:int = 2;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_266)
         {
            for each(_loc2_ in this.var_266 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_977 >= 0 && this._parts.length > this.var_977)
         {
            _loc2_ = this._parts[this.var_977];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         var _loc1_:Array = this.var_266[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_266.length <= param1)
         {
            return null;
         }
         return this.var_266[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_977] as AvatarEditorGridPartItem;
      }
