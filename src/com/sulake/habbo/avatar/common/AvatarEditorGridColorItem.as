package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_962:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_602.width,this.var_602.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_602,this.var_602.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_935.width,this.var_935.height,true,0);
            _loc5_ = this.var_935.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_962.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_933.width,this.var_933.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_933,this.var_933.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_962)
            {
               switch(this.var_962.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_47:
                     _loc4_.style = HabboIconType.const_783;
                     _loc4_.visible = true;
               }
            }
            else
