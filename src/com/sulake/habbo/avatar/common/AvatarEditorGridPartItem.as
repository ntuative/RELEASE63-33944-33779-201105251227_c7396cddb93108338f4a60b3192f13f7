package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_70:IAvatarEditorCategoryModel;
      
      private var _window:IWindowContainer;
      
      private var var_1469:IWindow;
      
      private var var_824:IFigurePartSet;
      ...
      private var var_1952:BitmapData;
      
      private const const_2237:int = 13421772;
      
      private const const_2236:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         this.var_824 = param3;
         this._window = param1;
         this.var_1469 = this._window.findChildByTag("BG_COLOR");
         this._colors = param4;
         this.var_1951 = param5;
         if(param3 == null)
         {
            this.var_706 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1950 = Math.max(this.var_1950,_loc6_.colorLayerIndex);
            }
         }
         this.var_447 = this.var_70.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_706 != null && !this.var_1951)
            {
               _loc3_ = this.var_706;
            }
            else
            ...
            if(this.var_824)
            {
               switch(this.var_824.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_47:
                     _loc2_.style = HabboIconType.const_783;
               }
            }
            else
            {
         ...
         if(this.isSelected)
         {
            this.var_1469.color = this.const_2237;
         }
         else
         {
            this.var_1469.color = this.const_2236;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_368[_loc6_] + "_" + FigureData.const_150;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_648 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1952)
               {
                  _loc9_ = this.var_70.controller.assets.getAssetByName("avatar_editor_download_icon");
                  this.var_1952 = _loc9_.content as BitmapData;
               }
         ...
         _loc1_ = new BitmapData(this.var_648.width,this.var_648.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_648.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_648.y;
               if(this.var_1951 && _loc2_.colorLayerIndex > 0)
               {
