package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1944:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1376:IAvatarImage;
      ...
      private var var_90:AvatarCanvas;
      
      private var _disposed:Boolean;
      
      private var _bodyPartCache:AvatarImageBodyPartCache;
      
      private var var_349:IActiveActionData;
      ...
      private var var_2228:ByteArray;
      
      private var var_2229:ImageData;
      
      private var var_1085:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_725 == GeometryType.const_1336 && param1 == GeometryType.const_1182 || this.var_725 == GeometryType.const_1182 && param1 == GeometryType.const_1336)
         {
            this.var_725 = param1;
            this.var_90 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_349 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_349;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_349 || !this.var_349.definition))
         {
            if(this.var_349.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_349.definition.state + "." + this.var_349.actionParameter);
               _loc13_ = param2 - this.var_349.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_349.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     {
                        this.var_349 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_915)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_504)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1376.getFigure(),_loc5_,this.var_725,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_438 == null)
         {
            ...
            this.var_438 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_349);
            if(this.var_438 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_90)
         {
            this.var_90 = this._structure.getCanvas(this._scale,this.var_725);
            if(!this.var_90)
            {
               return null;
            }
            this.var_2227 = new Point(0,this.var_90.height - int(this.var_90.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1736[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_847 || _loc10_ == AvatarAction.const_425;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1398 = this.var_115.bodyPartId;
               this.var_180 = this.var_115.partType;
               this.var_1670 = this.var_115.partId;
               ...
               this.var_1397 = this._scale + "_" + this.var_115.action.assetPartDefinition + "_" + this.var_180 + "_" + this.var_1670 + "_" + _loc5_ + "_" + this._frame;
               this.var_411 = this._assets.getAssetByName(this.var_1397) as BitmapDataAsset;
               if(this.var_411 == null)
               {
                  this.var_1397 = this._scale + "_std_" + this.var_180 + "_" + this.var_1670 + "_" + _loc5_ + "_0";
                  this.var_411 = this._assets.getAssetByName(this.var_1397) as BitmapDataAsset;
               }
               if(!(!this.var_411 || !this.var_411.content))
               {
                  ...
                  {
                     this.var_1085 = this._structure.renderManager.paletteManager.getPalette(this.var_115.paletteMapId);
                     if(this.var_1085 != null)
                     {
                        this.var_904 = this.var_411.content as BitmapData;
                        this.var_179 = new BitmapData(this.var_904.width,this.var_904.height);
                        this.var_2228 = this.var_1085.colorize(this.var_904.getPixels(this.var_904.rect));
                        this.var_179.setPixels(this.var_179.rect,this.var_2228);
                     }
                     else
                     {
                        this.var_179 = (this.var_411.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1398 == AvatarBodyPartType.const_259 || this.var_1398 == AvatarBodyPartType.const_1761 || this.var_1398 == AvatarBodyPartType.const_1889) && this.var_115.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  this.var_903 = this.var_411.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_55)
                     {
                  ...
                  this.var_2229 = new ImageData(this.var_179,this.var_903,_loc7_);
                  this.var_905.push(this.var_2229);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_905,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2227.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_55)
            {
         ...
         _loc8_ = this.var_905.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_905.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
