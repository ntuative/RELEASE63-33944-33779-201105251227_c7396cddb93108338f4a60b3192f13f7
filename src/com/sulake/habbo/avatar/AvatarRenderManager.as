package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2235:String = "hd-99999-99999";
      ...
      private var var_1933:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_338 = RenderMode.const_1910;
         ...
         this.var_112.add(AvatarType.const_122,_loc4_);
         ...
         this.var_112.add(AvatarType.const_57,_loc4_);
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_112.getValues())
            {
               _loc1_.dispose();
            }
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_319.init();
         this.var_817.init();
         _loc2_ = this.var_112.getValue(AvatarType.const_122) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_112.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_112.getValue(AvatarType.const_122) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1079)
         {
            if(this.var_2690 && this.var_2689 && this.var_2688)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_112.getValue(AvatarType.const_122) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1933)
         {
            this.var_1933 = new AvatarFigureContainer(this.const_2235);
         }
         this.var_235.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1933,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc3_ in this.var_320.getKeys())
         {
            _loc4_ = this.var_320.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1789)
         {
            _loc6_ = !this.var_319.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_319.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_112.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_112.getValue(AvatarType.const_57);
      ...
      {
         var _loc2_:AvatarStructure = this.var_112.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_112.getValue(AvatarType.const_122) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_57:
               _loc3_ = this.var_112.getValue(AvatarType.const_57) as AvatarStructure;
               break;
            default:
