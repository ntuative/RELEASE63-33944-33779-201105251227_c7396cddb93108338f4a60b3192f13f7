   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_70,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_70,FigureData.const_292,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_70,FigureData.const_254,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_70 && var_151 == "")
         {
            var_70.switchCategory(FigureData.TROUSERS);
         }
      }
