package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1851:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc15_:* = null;
         var _loc16_:* = null;
         this.var_982 = new Vector3D(0,0,10);
         super();
         this.var_1208 = new Matrix4x4();
         this.var_788 = new Dictionary();
         this.var_1852 = new Dictionary();
         this.var_1851 = new AvatarSet(param1.avatarset[0]);
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_982.x = _loc11_;
            this.var_982.y = _loc12_;
            this.var_982.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            for each(_loc9_ in _loc6_.bodypart)
            {
               ...
               for each(_loc16_ in _loc10_.method_15())
               {
                  _loc8_[_loc16_] = _loc10_;
               }
            }
            this.var_788[String(_loc6_.@id)] = _loc7_;
            this.var_1852[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      public function removeDynamicItems() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_788)
         {
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_1851.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_1851.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_788[param1] != null;
      }
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = this.var_788[param1] as Dictionary;
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(this.typeExists(param1))
         {
            return this.var_788[param1] as Dictionary;
         }
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1852[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         for each(_loc7_ in _loc5_)
         {
            ...
            _loc9_ = _loc7_.getDistance(this.var_982);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            return _loc5_.getParts(this.var_1208,this.var_982,param4);
         }
         return [];
      }
