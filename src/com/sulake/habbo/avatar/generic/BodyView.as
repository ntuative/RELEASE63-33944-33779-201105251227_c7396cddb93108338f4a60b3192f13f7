package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_645:String = "tab_boy";
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_70,FigureData.FACE,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_70.controller.gender)
         {
            case FigureData.const_82:
               activateTab(this.const_645);
               inactivateTab(this.const_644);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_644);
               inactivateTab(this.const_645);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_645:
                  var_70.controller.gender = FigureData.const_82;
                  param1.stopPropagation();
                  break;
               case this.const_644:
                  var_70.controller.gender = FigureData.FEMALE;
                  param1.stopPropagation();
            }
         }
