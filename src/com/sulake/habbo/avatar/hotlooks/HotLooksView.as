package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_70:HotLooksModel;
      ...
      public function init() : void
      {
         ...
         this.var_598 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_598.numGridItems > 0)
         {
            this.var_598.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_70 = null;
      ...
      public function update() : void
      {
         ...
         var _loc2_:* = null;
         this.var_598.removeGridItems();
         for each(_loc2_ in this.var_70.hotLooks)
         {
            _loc1_ = _loc2_.view.window;
            this.var_598.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_598.getGridItemIndex(param2.parent);
            this.var_70.selectHotLook(_loc3_);
         }
      }
