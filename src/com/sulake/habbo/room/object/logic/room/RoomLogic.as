package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1468:uint = 16777215;
      
      private var var_1825:int = 255;
      
      private var var_1183:uint = 16777215;
      
      private var var_1824:int = 255;
      
      private var var_1182:int = 0;
      
      private var var_1826:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_608,RoomObjectMouseEvent.const_136];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1219,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_988,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_987,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_791,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1182)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1823;
            if(_loc2_ - this.var_1182 >= this.var_1826)
            {
               _loc3_ = this.var_1183;
               _loc4_ = this.var_1824;
               this.var_1182 = 0;
            }
            else
            {
               _loc7_ = this.var_1468 >> 16 & 255;
               _loc8_ = this.var_1468 >> 8 & 255;
               _loc9_ = this.var_1468 & 255;
               _loc10_ = this.var_1183 >> 16 & 255;
               _loc11_ = this.var_1183 >> 8 & 255;
               _loc12_ = this.var_1183 & 255;
               _loc13_ = (_loc2_ - this.var_1182) / this.var_1826;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1825 + (this.var_1824 - this.var_1825) * _loc13_;
               this._color = _loc3_;
               this.var_1823 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_988,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_876:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_923:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_564:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_267)
               {
                  _loc5_ = "null";
               }
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1132,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1284:
               param2.setNumber(RoomObjectVariableEnum.const_987,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1167:
               param2.setNumber(RoomObjectVariableEnum.const_791,_loc3_);
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_668:
               param2.setNumber(RoomObjectVariableEnum.const_1141,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1317:
               param2.setNumber(RoomObjectVariableEnum.const_1215,param1.value);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1303,int(param1.bgOnly));
         this.var_1468 = this._color;
         this.var_1825 = this.var_1823;
         this.var_1183 = _loc3_;
         this.var_1824 = _loc4_;
         this.var_1182 = getTimer();
         this.var_1826 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_563,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1872,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1816,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1784,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_563,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_248 || _loc12_ == RoomPlaneData.const_414)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
