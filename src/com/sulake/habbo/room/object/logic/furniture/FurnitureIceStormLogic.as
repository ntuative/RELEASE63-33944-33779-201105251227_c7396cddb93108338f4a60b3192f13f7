   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2790 = param1.extra;
            this.var_1292 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1292 > 0 && param1 >= this.var_1292)
         {
            this.var_1292 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_2021,String(this.var_2021),this.var_2790);
