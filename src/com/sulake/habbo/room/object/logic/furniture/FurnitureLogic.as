package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      private static const const_447:int = 8;
      
      private static const const_1021:Number = 0.0625;
      ...
      private var var_1152:RoomObjectUpdateMessage;
      
      private var var_929:Vector3d;
      
      private var var_253:Array;
      
      public function FurnitureLogic()
      {
         this.var_929 = new Vector3d();
         this.var_253 = [];
         super();
      }
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_302,RoomObjectRoomAdEvent.const_320,RoomObjectRoomAdEvent.const_501,RoomObjectStateChangeEvent.const_66,RoomObjectMouseEvent.const_136,RoomObjectRoomAdEvent.const_196,RoomObjectMouseEvent.const_597];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         this.var_2385 = this.var_537 / 2;
         this.var_2386 = this.var_650 / 2;
         _loc3_ = _loc2_.@centerZ;
         if(_loc3_.length() == 1)
         {
            this.var_1751 = Number(_loc3_);
         }
         else
         {
            this.var_1751 = this.var_1440 / 2;
         }
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_378,this.var_650,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_785,this.var_1440,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1752,this.var_2385,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1771,this.var_2386,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1150,this.var_1751,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_711,this.var_253,true);
            ...
            case MouseEvent.ROLL_OUT:
               if(this.var_1153)
               {
                  if(eventDispatcher != null && _loc7_ != null && _loc7_.indexOf("http") == 0)
                  {
                     _loc4_ = object.getId();
                     _loc5_ = object.getType();
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_320,_loc4_,_loc5_));
                  }
                  this.var_1153 = false;
               }
               break;
      ...
      override public function useObject() : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_501,_loc1_,_loc2_));
               }
            }
            if(eventDispatcher != null)
            {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc2_.setString(RoomObjectVariableEnum.const_315,String(param1.extra));
            }
            _loc2_.setNumber(RoomObjectVariableEnum.const_730,lastUpdateTime);
         }
      }
      ...
      private function handleItemDataUpdateMessage(param1:RoomObjectItemDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1101,param1.itemData);
         }
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1.dir != null && param1.loc != null)
         {
            if(!(param1 is RoomObjectMoveUpdateMessage))
            {
               ...
               if(_loc4_ != null && _loc4_.x != param1.dir.x && this.var_1750 && _loc5_ != null && _loc5_.x == param1.loc.x && _loc5_.y == param1.loc.y && _loc5_.z == param1.loc.z)
               {
                  this.var_355 = 1;
                  this.var_1152 = new RoomObjectUpdateMessage(param1.loc,param1.dir);
                  param1 = null;
               }
            }
            this.var_1750 = true;
      ...
      override protected function getLocationOffset() : IVector3d
      {
         if(this.var_355 > 0)
         {
            this.var_929.x = 0;
            this.var_929.y = 0;
            if(this.var_355 <= const_447 / 2)
            {
               this.var_929.z = const_1021 * this.var_355;
            }
            else if(this.var_355 <= const_447)
            {
               if(this.var_1152)
               {
                  super.processUpdateMessage(this.var_1152);
                  this.var_1152 = null;
               }
               this.var_929.z = const_1021 * (const_447 - this.var_355);
            }
            return this.var_929;
         }
         return null;
