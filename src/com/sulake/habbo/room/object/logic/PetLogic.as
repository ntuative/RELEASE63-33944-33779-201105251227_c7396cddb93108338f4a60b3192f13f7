package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      private var var_2839:Boolean = false;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_136,RoomObjectMoveEvent.const_436];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2839)
         {
            ...
            if(param1 is RoomObjectAvatarUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_209,_loc4_.dirHead);
               return;
            }
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1481 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_972,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1670,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_927,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_209,_loc3_ + this.var_1060);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_2055;
            _loc2_.setNumber(RoomObjectVariableEnum.const_263,this.var_2055);
            _loc2_.setNumber(RoomObjectVariableEnum.const_162,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_2056;
            _loc2_.setNumber(RoomObjectVariableEnum.const_162,this.var_2056);
         }
         else
         {
            this.var_1060 += 45;
