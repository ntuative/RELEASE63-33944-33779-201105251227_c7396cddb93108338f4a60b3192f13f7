package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_664:PetVisualizationData = null;
      ...
      private const const_2219:int = 3;
      ...
      private const const_1403:int = 3;
      ...
      private var var_1756:Number = NaN;
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_500.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_500.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
      ...
      {
         this.var_664 = param1 as PetVisualizationData;
         createSprites(this.const_1403);
         var _loc2_:BitmapData = (this.var_664.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
         this.var_378 = new ExperienceData(_loc2_.clone());
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_1996 = param1.getNumber(RoomObjectVariableEnum.const_383) > 0;
            this.var_1446 = param1.getString(RoomObjectVariableEnum.const_162);
            this.var_277 = param1.getString(RoomObjectVariableEnum.const_263);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_883);
            this.var_1756 = param1.getNumber(RoomObjectVariableEnum.const_209);
            this.var_1445 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2405 = param1.getNumber(RoomObjectVariableEnum.const_972);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_200);
            if(this.var_583 != _loc3_)
            {
               this.var_583 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_483 != param1.getUpdateID() || this.var_1740 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1756;
            if(isNaN(this.var_1756))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc5_ != this.var_2000 || param3)
            {
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         var _loc3_:IAvatarImage = this.var_500.getValue(_loc2_) as IAvatarImage;
         if(_loc3_ == null)
         {
            _loc3_ = this.var_664.getAvatar(this.var_583,param1,this);
            if(_loc3_ != null)
            {
               this.var_500.add(_loc2_,_loc3_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_663 = null;
         _loc2_ = getSprite(this.const_1950);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc10_ || _loc7_ != var_93 || this.var_61 == null)
         {
            if(_loc7_ != var_93)
            {
               var_93 = _loc7_;
         ...
         var _loc12_:Boolean = this.var_952 || this.var_1155 > 0 || this.var_1754;
         this.var_378.alpha = 0;
         if(this.var_1445 > 0)
         {
            _loc13_ = param2 - this.var_1445;
            if(_loc13_ < AvatarAction.const_1060)
            {
               this.var_378.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_378.setExperience(this.var_2405);
               this.var_1155 = this.const_2219;
            }
            else
            {
               this.var_1445 = 0;
            }
            _loc14_ = getSprite(this.const_1980);
            if(_loc14_ != null)
            {
               if(this.var_378.alpha > 0)
               {
                  _loc14_.asset = this.var_378.image;
                  _loc14_.offsetX = -20;
                  _loc14_.offsetY = -80;
                  _loc14_.alpha = this.var_378.alpha;
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1446 != null && this.var_1446 != "")
         {
            param1.appendAction(AvatarAction.const_342,this.var_1446);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1403;
