package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_663:int = 1;
      
      private static const const_1060:int = 1000;
      
      private static const const_1495:String = "pet_experience_bubble_png";
      ...
      private var var_378:ExperienceData;
      ...
      public function AnimatedPetVisualization()
      {
         ...
         this.var_996 = [];
         super();
         while(this.var_122.length < ANIMATION_INDEX_COUNT)
         {
            this.var_122.push(new AnimationStateData());
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_122 != null)
         {
            ...
            {
               _loc2_ = this.var_122[_loc1_] as AnimationStateData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1495) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_378 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2653)
            {
               this.var_2653 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_154)
         {
            ...
            this.var_1996 = _loc3_.getNumber(RoomObjectVariableEnum.const_383) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_209);
            if(!isNaN(_loc8_))
            {
               this.var_1907 = _loc8_;
            }
            else
            {
               this.var_1907 = direction;
            }
            this.var_1445 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2405 = _loc3_.getNumber(RoomObjectVariableEnum.const_972);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_927);
            if(_loc9_ != this.var_1908)
            {
               this.var_1908 = _loc9_;
               this.var_2652 = this.var_1908.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         {
            this.var_378.alpha = 0;
            if(this.var_1445 > 0)
            {
               _loc2_ = param1 - this.var_1445;
               if(_loc2_ < const_1060)
               {
                  this.var_378.alpha = int(Math.sin(_loc2_ / const_1060 * 0) * 255);
                  this.var_378.setExperience(this.var_2405);
               }
               else
               {
                  this.var_1445 = 0;
               ...
               if(_loc3_ != null)
               {
                  if(this.var_378.alpha > 0)
                  {
                     _loc3_.asset = this.var_378.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_378.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_277)
         {
            ...
            this.setAnimationForIndex(const_1492,_loc3_);
         }
         if(param2 != this.var_1446)
         {
      ...
      {
         return super.getAdditionalSpriteCount() + const_663;
      }
      ...
      override protected function resetAllAnimationFrames() : void
      {
         var _loc2_:* = null;
         this.var_1522 = false;
         var _loc1_:int = this.var_122.length - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_122[_loc1_];
            if(_loc2_ != null)
            {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:int = this.var_122.length - 1;
         while(_loc5_ >= 0)
         {
            _loc6_ = this.var_122[_loc5_];
            if(_loc6_ != null)
            {
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2652);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_663)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_663))
            {
               if(param2 >= FurnitureVisualizationData.const_514.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_514[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1907);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_93,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1493)
            {
               this.var_996[param1] = true;
            }
            else
            {
               this.var_996[param1] = false;
            }
         }
         return this.var_996[param1];
      }
   }
}
