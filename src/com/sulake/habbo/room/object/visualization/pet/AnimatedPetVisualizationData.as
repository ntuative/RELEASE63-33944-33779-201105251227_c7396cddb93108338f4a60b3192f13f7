package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualizationData extends AnimatedFurnitureVisualizationData
   {
      ...
      private var var_2361:IAssetLibrary = null;
      ...
      {
         var _loc3_:PetAnimationSizeData = method_1(param1) as PetAnimationSizeData;
         if(_loc3_ != null)
         {
            return _loc3_.getAnimationForPosture(param2);
         }
         return PetAnimationSizeData.const_831;
      }
      ...
      {
         var _loc2_:PetAnimationSizeData = method_1(param1) as PetAnimationSizeData;
         if(_loc2_ != null)
         {
