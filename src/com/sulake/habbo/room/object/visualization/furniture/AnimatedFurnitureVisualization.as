package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_116:AnimationStateData;
      ...
      {
         super();
         this.var_116 = new AnimationStateData();
      }
      ...
      {
         return this.var_116.animationId;
      }
      
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         var _loc2_:int = this.animationId;
         if(_loc2_ != const_1270 && this._animationData.hasAnimation(this.var_494,_loc2_))
         {
            return _loc2_;
         }
         return const_1270;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_730);
                  this.var_1685 = _loc6_;
               }
            }
            return true;
         }
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_730);
      ...
      protected function setAnimation(param1:int) : void
      {
         ...
         {
            this.setSubAnimation(this.var_116,param1,this._state >= 0);
         }
      }
      ...
      {
         return this.var_116.getLastFramePlayed(param1);
      }
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_116 != null)
         {
            this.var_116.setLayerCount(this.var_670);
         }
      }
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_116.animationOver || this.var_912)
         {
            _loc2_ = this.updateFramesForAnimation(this.var_116,param1);
            if(this.var_116.animationOver)
            {
               if(AnimationData.isTransitionFromAnimation(this.var_116.animationId) || AnimationData.isTransitionToAnimation(this.var_116.animationId))
               {
                  this.setAnimation(this.var_116.animationAfterTransitionId);
                  this.var_116.animationOver = false;
               }
            }
         }
         return _loc2_;
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc11_:* = null;
         var _loc12_:int = 0;
         if(param1.animationOver && !this.var_912)
         {
            return 0;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(!_loc9_ || this.var_912)
            {
               ...
               if(this.var_912 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  _loc12_ = 0;
                  if(_loc11_ != null)
                  {
                  ...
                  if(_loc12_ == AnimationFrame.const_1259)
                  {
      ...
      {
         var _loc3_:AnimationFrame = this.var_116.getFrame(param2);
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_116.getFrame(param3);
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
