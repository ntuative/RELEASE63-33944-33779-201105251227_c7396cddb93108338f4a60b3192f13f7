package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualizationData extends FurnitureVisualizationData
   {
      ...
      {
         var _loc3_:AnimationSizeData = method_1(param1) as AnimationSizeData;
         if(_loc3_ != null)
         {
      ...
      {
         var _loc4_:AnimationSizeData = method_1(param1) as AnimationSizeData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc6_:AnimationSizeData = method_1(param1) as AnimationSizeData;
         if(_loc6_ != null)
         {
      ...
      {
         var _loc8_:AnimationSizeData = method_1(param1) as AnimationSizeData;
         if(_loc8_ != null)
         {
