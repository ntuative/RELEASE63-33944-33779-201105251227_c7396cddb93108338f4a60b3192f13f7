package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public static const const_514:Array = new Array("a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z");
      ...
      private var var_948:SizeData = null;
      ...
      public function getSize(param1:int) : int
      {
         ...
         this.var_2463 = _loc3_;
         return _loc3_;
      }
      
      public function getLayerCount(param1:int) : int
      {
         var _loc2_:SizeData = this.method_1(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:SizeData = this.method_1(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc4_:SizeData = this.method_1(param1);
         if(_loc4_ != null)
         {
      ...
      protected function method_1(param1:int) : SizeData
      {
         ...
         if(_loc2_ < this._sizes.length)
         {
            this.var_948 = this.var_305.getValue(String(this._sizes[_loc2_])) as SizeData;
         }
         else
         {
            this.var_948 = null;
