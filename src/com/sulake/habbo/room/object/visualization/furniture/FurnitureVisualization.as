package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1931:Number = Math.sqrt(0.5);
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1461 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1461;
            this.var_1461 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2433;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_401:
               break;
            case LayerData.const_1109:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1158:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_483 != _loc3_.getUpdateID() || param1 != var_93 || param2 != this.var_2480)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2483 = _loc3_.getNumber(RoomObjectVariableEnum.const_247);
            ...
            this.var_1176 = this.getAdClickUrl(_loc3_);
            if(this.var_1176 == null || this.var_1176.indexOf("http") != 0)
            {
               this.var_1176 = null;
            }
            this.var_2433 = this.var_1176 != null;
            this.var_2479 = _loc3_.getNumber(RoomObjectVariableEnum.const_872);
      ...
      {
         if(this.var_2482 != param2 || this.var_2481 != param1)
         {
            this.var_956 = [];
            this.var_957 = [];
            this.var_768 = [];
      ...
      {
         this.var_670 = param1;
         this.var_1460 = this.var_670 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_514.length)
         {
            return "";
         }
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param2 != this.var_1460)
            {
               _loc6_ = FurnitureVisualizationData.const_514[param2];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_765[param3] != null && !this.var_1806)
         {
      ...
      {
         if(this.var_766[param2] != null)
         {
            return this.var_766[param2];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2479 * (param1 / 2));
      }
      ...
      {
         if(this.var_763[param3] != null)
         {
            return this.var_763[param3];
         }
         if(this._data == null)
         {
