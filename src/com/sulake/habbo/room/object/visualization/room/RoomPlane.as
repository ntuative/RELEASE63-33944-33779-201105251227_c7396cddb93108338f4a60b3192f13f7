package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1170:Vector3d = null;
      ...
      private var var_1842:Boolean = true;
      ...
      private var var_232:BitmapData = null;
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_654);
                  return param1;
               }
            }
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_778 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_370))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            _loc6_ = this.var_304.length * param1.scale;
            ...
            if(this.var_971 != null)
            {
               _loc3_ = this.var_971.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1842,this.var_2558,this.var_2561,this.var_2562,this.var_2559,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1740 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            originPos = geometry.getScreenPosition(this.var_1170);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_158.z - originZ,this.var_119.z - originZ,this.var_88.z - originZ,this.var_118.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2448 = relativeDepth;
            this._isVisible = true;
            this.var_1740 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2560);
      ...
      {
         this.var_158.assign(param1.getScreenPosition(this.var_98));
         this.var_119.assign(param1.getScreenPosition(Vector3d.sum(this.var_98,this.var_304)));
         this.var_88.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_98,this.var_303),this.var_304)));
         this.var_118.assign(param1.getScreenPosition(Vector3d.sum(this.var_98,this.var_303)));
         this._offset = param1.getScreenPoint(this.var_1170);
         ...
         var _loc2_:Number = Math.min(this.var_158.x,this.var_119.x,this.var_88.x,this.var_118.x);
         var _loc3_:Number = Math.max(this.var_158.x,this.var_119.x,this.var_88.x,this.var_118.x);
         var _loc4_:Number = Math.min(this.var_158.y,this.var_119.y,this.var_88.y,this.var_118.y);
         var _loc5_:Number = Math.max(this.var_158.y,this.var_119.y,this.var_88.y,this.var_118.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_158 == null || this.var_119 == null || this.var_88 == null || this.var_118 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         var _loc3_:Number = this.var_118.x - this.var_88.x;
         var _loc4_:Number = this.var_118.y - this.var_88.y;
         var _loc5_:Number = this.var_119.x - this.var_88.x;
         var _loc6_:Number = this.var_119.y - this.var_88.y;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_263.length == this.var_972.length)
         {
            while(_loc1_ < this.var_263.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_972.length)
                  {
                     _loc7_ = this.var_972[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_369.length > this.var_1486.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_973 || this.var_263.length == 0 && this.var_369.length == 0 && !this.var_370 || this.var_798 == null)
         {
            return;
         }
         ...
         if(this.var_370)
         {
            ...
            while(_loc5_ < this.var_263.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_72.width - this.var_72.width * _loc3_.leftSideLoc / this.var_303.length;
                  _loc11_ = this.var_72.height - this.var_72.height * _loc3_.rightSideLoc / this.var_304.length;
                  _loc12_ = _loc3_.type;
                  this.var_798.updateMask(this.var_72,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_972.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_369.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_72.width - this.var_72.width * _loc4_.leftSideLoc / this.var_303.length;
                  _loc11_ = this.var_72.height - this.var_72.height * _loc4_.rightSideLoc / this.var_304.length;
                  _loc13_ = this.var_72.width * _loc4_.leftSideLength / this.var_303.length;
                  _loc14_ = this.var_72.height * _loc4_.rightSideLength / this.var_304.length;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_232 != null && (this.var_232.width != param1.width || this.var_232.height != param1.height))
         {
            this.var_232.dispose();
            this.var_232 = null;
         }
         if(this.var_232 == null)
         {
            this.var_232 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_232.copyChannel(param1,param1.rect,const_654,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_232.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_232,this.var_232.rect,const_654,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
