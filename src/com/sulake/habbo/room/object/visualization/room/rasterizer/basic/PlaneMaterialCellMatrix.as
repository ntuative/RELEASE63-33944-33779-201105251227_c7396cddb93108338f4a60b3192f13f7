package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_264:int = 4;
      
      public static const const_257:int = 5;
      
      public static const const_827:int = 6;
      
      public static const const_1811:int = const_410;
      ...
      private var var_2445:Number = -1.0;
      
      private var _normalMaxX:Number = 1.0;
      
      private var var_2446:Number = -1.0;
      
      private var var_2444:Number = 1.0;
         ...
         if(this.isStatic)
         {
            if(this.var_31 != null)
            {
               if(this.var_31.width == param2 && this.var_31.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_605,param6,param7);
                     return param1;
                  }
                  return this.var_31;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         {
            _loc5_ = new Rectangle(0,0,this.var_31.width,this.var_605);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_31.height - this.var_605,this.var_31.width,this.var_605);
         }
