package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_940:Boolean = true;
      ...
      private var var_1162:Point = null;
      
      private var var_1452:LayoutRasterizerData = null;
      ...
      {
         if(param1 != this.var_941)
         {
            this.var_941 = param1;
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1452 = this.var_45.getValue(this.var_941);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2430 = new Vector3d(-0.5,0.5,0);
         this.var_940 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2430);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1162.x = _loc3_.x;
         this.var_1162.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_45.getValue(this.var_941);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1773 = RoomObjectVariableEnum.const_1296;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1773 = RoomObjectVariableEnum.const_1154;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1163 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1163 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_45.getValue(this.var_941);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2428 && param3 == this.var_2429)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1163 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1163 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1773);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_562;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1452.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1162.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1162.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_421.indexOf(_loc10_) >= 0 && this.var_940)
            {
               param1 = this.var_421.indexOf(_loc10_);
               if(this.var_604[param1] != "")
               {
                  _loc9_ = this.var_816.getAsset(this.var_604[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_603[param1] != -1)
               {
                  param2.alpha = this.var_603[param1];
               }
               this.var_421.splice(param1,1);
               this.var_604.splice(param1,1);
               this.var_603.splice(param1,1);
      ...
      public function exchangeElementGraphics(param1:String, param2:String) : void
      {
         ...
         if(_loc3_ < 0)
         {
            ...
            this.var_604.push(param2);
            this.var_603.push(-1);
         }
         else
         {
            this.var_604[_loc3_] = param2;
         }
      }
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_421.push(param1);
            this.var_604.push("");
            this.var_603.push(param2);
         }
         else
         {
            this.var_603[_loc3_] = param2;
         }
      }
   }
}
