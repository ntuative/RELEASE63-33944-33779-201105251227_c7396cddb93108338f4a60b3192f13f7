package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1764:int = 13421772;
      
      private static const const_1008:int = 16777215;
      
      private static const const_1006:int = 13421772;
      
      private static const const_1007:int = 10066329;
      
      private static const const_1009:int = 10066329;
      
      public static const const_1678:int = 16777215;
      
      public static const const_1804:int = 13421772;
      
      public static const const_1725:int = 10066329;
      ...
      private var var_738:Rectangle = null;
      ...
      private var var_1434:Number = NaN;
      
      private var var_1739:String = null;
      
      private var var_1145:uint = 16777215;
      
      private var var_2366:int = 255;
      
      private var var_2365:int = 255;
      ...
      private const const_2215:int = 250;
      
      private var var_1740:int = -1;
      
      private var var_1458:Number = 0.0;
      
      private var var_2369:Number = 0.0;
      
      private var var_2367:Number = 0.0;
      
      private var var_1741:Number = 0.0;
      ...
      private function resetRoomPlanes() : void
      {
         ...
         if(this.var_137 != null)
         {
            ...
            {
               _loc2_ = this.var_137[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_738 = super.boundingRectangle;
         }
         return new Rectangle(this.var_738.x,this.var_738.y,this.var_738.width,this.var_738.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_1434))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1434;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1219);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1199);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_286)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1679)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_73,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1841 + this.const_2215 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_352.length)
            {
               _loc11_ = this.var_597[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_352[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1742)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2368 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2365 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2366 / 255);
         ...
         var_154 = _loc7_.getUpdateID();
         this.var_1841 = _loc9_;
      }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1740)
         {
            this.var_1740 = param1.updateId;
            this.var_738 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1458 || _loc3_.y != this.var_2369 || _loc3_.z != this.var_2367 || param1.scale != this.var_1741))
            {
               this.var_1458 = _loc3_.x;
               this.var_2369 = _loc3_.y;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_154 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1132);
            if(_loc3_ != this.var_1739)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1739 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_988));
            if(_loc4_ != this.var_1145)
            {
               this.var_1145 = _loc4_;
               this.var_2368 = this.var_1145 & 255;
               this.var_2365 = this.var_1145 >> 8 & 255;
               this.var_2366 = this.var_1145 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1303));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_154 != param1.getUpdateID())
         {
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_987));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_791));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_154 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1141);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1215);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1434))
            {
               this._floorThicknessMultiplier = _loc2_;
               this.var_1434 = _loc3_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_352;
         if(this.var_352.length == 0)
         {
            _loc6_ = this.var_137;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_352.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_352.push(_loc12_);
                        this.var_597.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1146;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_73 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_267)
                              {
