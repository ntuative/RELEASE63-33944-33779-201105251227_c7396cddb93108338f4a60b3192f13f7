package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_752:String = "RCL_LOADER_READY";
      
      private static const const_367:String = "RCL_PUBLICROOM_";
      
      private static const const_1970:int = 0;
      ...
      private static const const_658:String = "wall_place_holder";
      
      private static const const_659:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_455;
      
      private static const const_660:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1059:String = "selection_arrow";
      ...
      private var var_1515:IEventDispatcher = null;
      ...
      {
         this.var_374 = new Dictionary();
         this._wallItems = new Dictionary();
         this._pets = new Dictionary();
         this.var_2616 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2615 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_1044)
         {
            return;
         }
         this.var_1515 = param1;
         this.var_2613 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2612 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_374)
            {
               delete this.var_374[_loc1_];
            }
            this.var_374 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_802.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_436.add(_loc3_,_loc4_);
               if(this.var_374[_loc7_] == null)
               {
                  this.var_374[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_634.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_635.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_635.remove(_loc7_);
               this.var_635.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2614)
         {
            ...
            {
               this.var_1515.dispatchEvent(new Event(const_752));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_523 != null)
         {
            this.var_523.remove(param1);
            this.var_523.add(param1,param2);
         }
         if(this.var_525 != null)
         {
      ...
      {
         return [const_455,const_658,const_659,const_660,TILE_CURSOR,const_1059];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_436.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_634.getValue(param1) as String;
      ...
      {
         return this.var_990.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_989[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_634.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_802.getValue(param1) != null)
         {
            return this.var_802.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_207 != null && this.var_207.hasWorldType(const_367 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_262 || param1 == RoomObjectVisualizationEnum.const_57 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_635.getValue(param1));
         }
         return 0;
      }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         switch(param2)
         {
            case RoomObjectCategoryEnum.const_27:
               this.var_436[param1] = _loc4_;
               break;
            case RoomObjectCategoryEnum.const_26:
               this.var_634[param1] = _loc4_;
               break;
            default:
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_374[_loc4_] == null)
                     {
                        this.var_374[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_207 = this.var_1514.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2616.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1913);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2615.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_480,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_989.add(_loc6_,_loc3_);
         }
      }
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_550.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(this.getObjectCategory(const_367 + param1) == RoomObjectCategoryEnum.const_80)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_207.getWorldHeightScale(const_367 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_207 != null)
         {
            return this.var_207.getWorldScale(const_367 + param1);
         }
         return 32;
      }
      ...
      public function setActiveObjectType(param1:int, param2:String) : void
      {
         ...
         this.var_436.add(param1,param2);
      }
   }
}
