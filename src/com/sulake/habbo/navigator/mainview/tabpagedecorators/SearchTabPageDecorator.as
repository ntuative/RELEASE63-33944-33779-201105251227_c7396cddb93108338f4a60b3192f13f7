package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1975:TextSearchInputs;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1975 == null)
         {
            ...
            this.var_1975 = new TextSearchInputs(this._navigator,false,_loc4_);
         ...
         {
            this.var_1975.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(this._navigator.data.guestRoomSearchResults.searchType == Tabs.const_424)
            {
      ...
      {
         this._navigator.mainViewCtrl.startSearch(Tabs.const_210,Tabs.const_244,"-1",MainViewCtrl.const_706);
      }
