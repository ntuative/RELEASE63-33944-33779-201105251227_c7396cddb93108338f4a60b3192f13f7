   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_146 == null)
         {
            ...
            this.var_146.addEventListener(WindowEvent.const_50,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_146 != null)
         {
            this.var_146.removeEventListener(WindowEvent.const_50,this.onFilterSelected);
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_190,Tabs.const_397);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_190,Tabs.const_907);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_190,Tabs.const_397,"" + _loc3_);
         }
         if(this.var_146)
         {
