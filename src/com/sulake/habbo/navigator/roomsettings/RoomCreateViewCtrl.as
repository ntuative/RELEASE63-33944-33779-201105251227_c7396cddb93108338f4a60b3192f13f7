package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1335:RoomLayout;
      
      private var var_689:Timer;
      
      private var var_2093:Boolean = true;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_689 = new Timer(100);
         this.var_689.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,80,"g"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,74,"h"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,416,"o"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,352,"p"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,304,"q"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,336,"r"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,748,"u"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_42,438,"v"));
      ...
      public function dispose() : void
      {
         if(this.var_689)
         {
            this.var_689.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_689.reset();
            this.var_689 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1335.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_2093 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2093 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_58 = IItemListWindow(this.var_195.findChildByName("item_list"));
         ...
         this.var_1336 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_195.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1336.goBackToInitialState();
         this.var_1336.input.textBackgroundColor = 4294967295;
         this.var_1335 = this.var_45[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_83,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1336.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1336.getText();
         var _loc3_:String = "model_" + this.var_1335.name;
