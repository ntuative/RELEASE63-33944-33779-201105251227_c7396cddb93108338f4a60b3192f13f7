package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_1254:RoomCreateViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1254 = new RoomCreateViewCtrl(this);
         this.var_2703 = new RoomThumbnailRenderer(this);
         this.var_898 = new GuestRoomPasswordInput(this);
         this.var_297 = new GuestRoomDoorbell(this);
         this.var_419 = new Tabs(this);
         this.var_1253 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_317,HabboWindowStyle.const_48,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_321.startSearch(Tabs.const_210,Tabs.const_424,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_321.startSearch(Tabs.const_287,Tabs.const_295);
         this.var_419.getTab(Tabs.const_287).tabPageDecorator.tabSelected();
      }
