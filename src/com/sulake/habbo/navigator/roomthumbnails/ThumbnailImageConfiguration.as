package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      private var var_2087:Rectangle;
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_2086 = this._navigator.getButtonImage(this.var_2084);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_2087 == null)
         {
            ...
            this.var_2087 = new Rectangle(this.var_1607,this.var_1607,_loc1_.width - 2 * this.var_1607,_loc1_.height - 2 * this.var_1607);
         }
         this.var_688.bitmap.fillRect(this.var_688.bitmap.rect,4281545523);
         this.var_688.bitmap.fillRect(this.var_2087,4284900966);
         this.copyTo(this.var_688.bitmap);
         if(this._selected)
         {
            this.var_688.bitmap.copyPixels(this.var_2085,this.var_2085.rect,new Point(0,0),null,null,true);
         }
