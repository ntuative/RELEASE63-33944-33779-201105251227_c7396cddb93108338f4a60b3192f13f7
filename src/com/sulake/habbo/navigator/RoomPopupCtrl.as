package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_128:GuestRoomData;
      
      private var var_2703:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2703 = new RoomThumbnailRenderer(param1);
         this.var_891 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_193,this.var_128);
         if(this.var_128.ownerName != "" && this.var_128.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_193,!!this.var_128.event ? this.getEventCtg(this.var_128.categoryId) : this.getRoomCtg(this.var_128.categoryId));
         this.refreshRoomDesc(this.var_193,this.var_128);
         this.refreshExtraCont();
         this.refreshInfo(this.var_193,"trading_allowed",this.var_128.allowTrading);
         this.refreshInfo(this.var_193,"doormode_doorbell",this.var_128.doorMode == 1);
         this.refreshInfo(this.var_193,"doormode_password",this.var_128.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_193,this.var_128.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_891.refreshTags(_loc1_,this.var_128.tags);
         this.refreshTextWithCaption("rating",_loc1_,"" + this.var_128.score);
         if(this.var_128.event)
         {
            this.refreshTextWithCaption("startedat",_loc1_,"" + this.var_128.eventCreationTime);
         }
         this.var_2703.refreshThumbnail(_loc1_,this.var_128.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_210,Tabs.const_244,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
