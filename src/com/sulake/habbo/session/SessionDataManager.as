package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_2067:GroupDetailsView;
      ...
      private var var_683:ProductDataParser;
      ...
      private var var_2068:UserTagManager;
      
      private var var_1321:BadgeImageManager;
      
      private var var_1319:HabboGroupInfoManager;
      
      private var var_1062:IgnoredUsersManager;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2978 = [];
         this.var_2068 = new UserTagManager(events);
         this.var_1319 = new HabboGroupInfoManager(this,events);
         this.var_1062 = new IgnoredUsersManager(this);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_329)
         {
            this.var_329.removeEventListener(FurnitureDataParser.const_123,this.onFurnitureReady);
            this.var_329.dispose();
            this.var_329 = null;
         }
         if(this.var_683)
         {
            this.var_683.removeEventListener(ProductDataParser.const_123,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1321 = new BadgeImageManager(context.root.assets,events,this.var_192,this._localization);
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_329)
         {
            ...
            this.var_329 = new FurnitureDataParser(this.var_557,this._wallItems,this.var_556,this._localization);
            this.var_329.addEventListener(FurnitureDataParser.const_123,this.onFurnitureReady);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2522 = _loc2_.clubLevel;
         this.var_2069 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2675 = _loc3_.respectTotal;
         this.var_1320 = _loc3_.respectLeft;
         this._petRespectLeft = _loc3_.petRespectLeft;
         this.var_583 = _loc3_.figure;
         this.var_902 = _loc3_.sex;
         this.var_1767 = _loc3_.realName;
         this.var_2847 = _loc3_.identityId;
         this.var_1062.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_583 = _loc2_.figure;
            this.var_902 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_583,this.var_902));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2846 = _loc2_.isOpen;
         this.var_2845 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_2069 >= SecurityLevelEnum.const_1238;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_2068.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1321.getBadgeImage(param1);
      }
      
      public function getBadgeImageWithInfo(param1:String) : BadgeInfo
      {
         return this.var_1321.getBadgeImageWithInfo(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_2067 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1319.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_2067.showGroupDetails(param1);
         }
      }
      ...
      {
         return this.var_1321.getBadgeImage(param1,BadgeImageManager.const_1307);
      }
      ...
      {
         return this.var_1062.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_1062.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_1062.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1320 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         _loc2_.send(new RespectUserMessageComposer(param1));
         this.var_1320 = this.var_1320 - 1;
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_556.getValue(param1);
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1322.indexOf(param1) == -1)
         {
         ...
         if(this.var_683 == null)
         {
            ...
            this.var_683 = new ProductDataParser(_loc2_,this.var_1130);
            this.var_683.addEventListener(ProductDataParser.const_123,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         {
            if(this.var_1063.indexOf(param1) == -1)
            {
