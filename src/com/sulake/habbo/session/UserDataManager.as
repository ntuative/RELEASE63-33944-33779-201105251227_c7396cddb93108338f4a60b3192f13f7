package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1506:int = 2;
      
      private static const const_1975:int = 3;
      ...
      {
         return this.getUserDataByType(param1,const_1505);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_1010.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         this.var_1010.remove(param1);
         this.var_1010.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1506);
      }
