package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1483:String = "sendAccessTokenToServer";
      
      private static const const_1484:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1483,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1484,this.jsFaceBookLogOutCallback);
