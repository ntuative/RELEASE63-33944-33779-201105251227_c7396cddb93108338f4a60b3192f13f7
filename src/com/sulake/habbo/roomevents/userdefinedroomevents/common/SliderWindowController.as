package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1168:Number = 1.0;
      
      private var var_606:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1168,param1);
         this.var_945 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_945);
         }
      ...
      {
         return int(this.var_1784 * (Number(param1 - this._minValue) / (this.var_1168 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1784 * (this.var_1168 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_944)
         {
            if(param1.type == WindowMouseEvent.const_54 || param1.type == WindowMouseEvent.const_213)
            {
               this.var_944 = false;
            }
         }
         if(!this.var_944 || param1.type != WindowEvent.const_433)
         {
            return;
         }
         if(this.var_606 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_606) * this.var_606;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_606 != 0)
            {
               _loc3_ = this.var_945 + this.var_606;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_750 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_750.width,this.var_750.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_750,this.var_750.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_749 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_749.width,this.var_749.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_749,this.var_749.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1784 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_750 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_749 = BitmapData(_loc2_.content);
      }
   }
}
