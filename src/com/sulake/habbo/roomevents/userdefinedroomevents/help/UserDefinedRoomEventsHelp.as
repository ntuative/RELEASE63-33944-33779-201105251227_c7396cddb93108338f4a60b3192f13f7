package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1726 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1140 = this.var_1726.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1140)
         {
            this.var_1140.procedure = this.onButtonClick;
         }
         this.var_1139 = this.var_1726.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1139)
         {
      ...
      {
         if(this.var_252 >= this.var_64.length - 1)
         {
      ...
      {
         ++this.var_252;
         this.var_252 = Math.min(this.var_252,this.var_64.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_64[this.var_252][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_64[this.var_252][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_64[this.var_252][1]).value;
