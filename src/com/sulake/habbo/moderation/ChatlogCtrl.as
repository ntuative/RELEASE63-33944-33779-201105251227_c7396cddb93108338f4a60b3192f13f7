package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1006:Array = [];
      
      private static var var_1935:int = 1000;
      
      private static var var_1007:Array = [];
      
      private static var var_1937:int = 200;
      ...
      private var var_1936:IMessageComposer;
      ...
      {
         this.var_819 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_818 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         this.var_504 = new Timer(1000,1);
         ...
         this.var_34.connection.send(this.var_1936);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1006.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_818.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1006.length < var_1935)
         {
            ...
            param1.width = this.var_818.width;
            param1.height = this.var_818.height;
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1537.getValue(param2.chatterName))
            {
               this.var_1537.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1537.getValue(_loc2_);
