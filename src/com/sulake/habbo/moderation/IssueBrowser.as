package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2217:String = "open_issues";
      
      private const const_2218:String = "picked_issues";
      ...
      private var var_1747:IIssueBrowserView;
      
      private var var_1748:IIssueBrowserView;
      
      private var var_1746:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_353.view.width = this.var_254.container.width;
         this.var_353.view.height = this.var_254.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2216:
               ...
               {
                  this.var_1747 = new MyIssuesView(this.issueManager,this,this.var_254.container);
               }
               return this.var_1747;
            case this.const_2217:
               if(this.var_1748 == null)
               {
                  this.var_1748 = new OpenIssuesView(this.issueManager,this,this.var_254.container);
               }
               return this.var_1748;
            case this.const_2218:
               if(this.var_1746 == null)
               {
                  this.var_1746 = new PickedIssuesView(this.issueManager,this,this.var_254.container);
               }
