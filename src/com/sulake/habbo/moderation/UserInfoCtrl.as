package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1036:int = 60;
      
      private static const const_1033:int = 3600;
      
      private static const const_1035:int = 86400;
      
      private static const const_1034:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1036)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1033)
         {
            return Math.round(param1 / const_1036) + " mins ago";
         }
         if(param1 < 2 * const_1035)
         {
            return Math.round(param1 / const_1033) + " hours ago";
         }
         if(param1 < 2 * const_1034)
         {
            return Math.round(param1 / const_1035) + " days ago";
         }
         return Math.round(param1 / const_1034) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1192.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_34.getXmlWindow("user_info"));
            this.var_1192.addChild(_loc1_);
            this.var_34.disableButton(this.var_34.method_2.chatlogsPermission,_loc1_,"chatlog_but");
            this.var_34.disableButton(this.var_34.method_2.alertPermission,_loc1_,"message_but");
            this.var_34.disableButton(this.var_34.method_2.alertPermission || this.var_34.method_2.kickPermission || this.var_34.method_2.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_34,WindowTracker.const_1129,this._data.userId),this._callerFrame,this.var_1193,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new RoomVisitsCtrl(this.var_34,this._data.userId),this._callerFrame,this.var_1193,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new SendMsgsCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1603),this._callerFrame,this.var_1193,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ModActionCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1603),this._callerFrame,this.var_1193,false,true);
      }
