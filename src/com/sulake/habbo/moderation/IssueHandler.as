package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_165:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_540:UserInfoCtrl;
      
      private var var_1281:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_68.disableButton(this.var_68.method_2.chatlogsPermission,this._window,"show_chatlog");
         _loc2_ = this._window.findChildByName("move_to_player_support");
         if(_loc2_ != null)
         {
            _loc2_.disable();
         }
         var _loc3_:IssueMessageData = this.var_165.getHighestPriorityIssue();
         this.var_540 = new UserInfoCtrl(this._window,this.var_68,_loc3_.message);
         this.var_1281 = new UserInfoCtrl(this._window,this.var_68,_loc3_.message);
         this.var_540.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_165.reportedUserId > 0)
         {
            this.var_1281.load(_loc4_,this.var_165.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_165.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_165.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_68 != null && this.var_68.issueManager != null && this.var_165 != null)
         {
            this.var_68.issueManager.removeHandler(this.var_165.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_68.issueManager.closeBundle(this.var_165.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_68.issueManager.closeBundle(this.var_165.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_68.issueManager.closeBundle(this.var_165.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_68.issueManager.releaseBundle(this.var_165.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_165.getHighestPriorityIssue().issueId;
         this.var_68.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_68,WindowTracker.const_1143,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_165.getHighestPriorityIssue();
            this.var_540 = new UserInfoCtrl(this._window,this.var_68,_loc3_.message);
            this.var_540.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
