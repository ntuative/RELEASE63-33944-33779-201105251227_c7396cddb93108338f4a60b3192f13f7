   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      public function show() : void
      {
         if(this._frame == null)
         {
            ...
            this._frame.findChildByName("room_tool_but").disable();
            this._frame.findChildByName("chatlog_but").disable();
            this.var_34.disableButton(this.var_34.method_2.cfhPermission,this._frame,"ticket_queue_but");
      ...
      {
         if(this.var_34.method_2.chatlogsPermission)
         {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!this.var_1865 ? 0 : 1,this._roomId),this.var_34,WindowTracker.const_852,this._roomId),this._frame,false,false,true);
      }
