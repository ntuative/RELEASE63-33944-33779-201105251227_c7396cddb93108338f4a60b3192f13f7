package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_695:Boolean = true;
      
      private var var_1002:ICheckBoxWindow;
      
      private var var_1525:ICheckBoxWindow;
      
      private var var_1524:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_347));
         Logger.log("BEGINNING TO SHOW: " + this.var_347);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1657;
      }
      ...
      private function setSendButtonState(param1:String) : void
      {
         ...
         if(_loc2_ && this.var_34.method_2.roomAlertPermission)
         {
            _loc3_.enable();
         }
         else
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_347);
         if(param1.flatId != this.var_347)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_347);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1002 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1525 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1524 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
         ...
         this.var_34.disableButton(this.var_34.method_2.chatlogsPermission,this._frame,"chatlog_but");
         if(!this.var_34.method_2.roomKickPermission)
         {
            this.var_1002.disable();
         }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_852,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_695 || this.var_560.text == "")
         {
            this.var_34.windowManager.alert("Alert","You must input a message to the user",0,this.method_8);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1002.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1833,_loc2_,this.var_560.text,"",""));
         if(this.var_1525.isSelected || this.var_1524.isSelected || this.var_1002.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1525.isSelected,this.var_1524.isSelected,this.var_1002.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1724);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1882);
      }
      ...
      private function method_8(param1:IAlertDialog, param2:WindowEvent) : void
      {
         param1.dispose();
      }
      ...
      {
         Logger.log("MSG TEMPLATES: " + this.var_34.method_2.roomMessageTemplates.length);
         param1.populate(this.var_34.method_2.roomMessageTemplates);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.method_2.roomMessageTemplates[this.var_1169.selection];
         if(_loc3_ != null)
         {
            this.var_695 = false;
