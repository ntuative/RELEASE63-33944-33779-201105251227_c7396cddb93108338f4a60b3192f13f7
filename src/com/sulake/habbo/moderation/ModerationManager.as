package com.sulake.habbo.moderation
{
   ...
   public class ModerationManager extends Component implements IHabboModeration
   {
      ...
      private var var_2186:ModerationMessageHandler;
      
      private var _issueManager:IssueManager;
      
      private var var_889:StartPanelCtrl;
      
      private var var_2184:WindowTracker;
      
      private var var_2185:ModeratorInitData;
      ...
      public function ModerationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_889 = new StartPanelCtrl(this);
         this.var_2184 = new WindowTracker();
      }
      ...
      public function userSelected(param1:int, param2:String) : void
      {
         ...
         this.var_889.userSelected(param1,param2);
      }
      ...
      public function get method_2() : ModeratorInitData
      {
      ...
      public function set method_2(param1:ModeratorInitData) : void
      {
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            this.var_2186 = new ModerationMessageHandler(this);
         }
      }
