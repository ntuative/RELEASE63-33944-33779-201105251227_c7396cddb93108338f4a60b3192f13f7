package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1454:int = HabboMusicPrioritiesEnum.const_132;
      ...
      private var var_508:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_740,this.onJukeboxInit);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_242,this.onJukeboxDispose);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_728,this.onSoundMachineInit);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_735,this.onSoundMachineDispose);
         this.var_1190 = new Timer(1000);
         this.var_1190.start();
         this.var_1190.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_234)
         {
            this.var_308[_loc6_] = null;
            this.var_775[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1832)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_394)
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_116,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_262)
            {
               ...
               {
                  _loc3_ = this.var_262.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_84)
            {
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_740,this.onJukeboxInit);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_242,this.onJukeboxDispose);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_728,this.onSoundMachineInit);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_735,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_234)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_308[param1] = _loc7_;
         this.var_775[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_308[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_308[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_775[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_308.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_308[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_262.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_234)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_616.add(param1,param2);
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_262.length)
         {
            ...
            if(_loc3_.id != this.var_1478 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_308[_loc2_] != null)
            {
               _loc3_ = this.var_308[_loc2_];
               _loc4_ = this.var_262.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_262.add(_loc6_.id,_loc10_);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_234)
         {
            return false;
         }
         ...
         this.var_1832 = this.getSongRequestCountAtPriority(param1);
         this.var_1478 = param2;
         if(this._priorityPlaying <= const_1454)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2551 != param1.id || _loc3_ > this.var_2550 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2551 = param1.id;
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_616.getValue(param1);
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_508 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_84,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_508 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
