package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_974,this.onSoundMachinePlayEvent);
         this.var_84.addEventListener(RoomEngineSoundMachineEvent.const_701,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_84)
            {
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_974,this.onSoundMachinePlayEvent);
               this.var_84.removeEventListener(RoomEngineSoundMachineEvent.const_701,this.onSoundMachineStopEvent);
               this.var_84 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_422);
      ...
      public function stopPlaying() : void
      {
         this.var_422 = -1;
         this.var_607 = false;
         this.var_228.stop(HabboMusicPrioritiesEnum.const_132);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_228.playSong(param1,HabboMusicPrioritiesEnum.const_132,_loc3_,0,0,0))
         {
