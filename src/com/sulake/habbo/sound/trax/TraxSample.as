package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1856:String = "sample_44khz";
      
      public static const const_1638:String = "sample_22khz";
      
      public static const const_1909:String = "sample_11khz";
      
      public static const const_1900:String = "sample_16bit";
      
      public static const const_1814:String = "sample_8bit";
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_156 * this.var_78;
         ...
         param1.position = 0;
         var _loc9_:int = 0;
         var _loc10_:int = _loc7_ / this.var_78;
         var _loc11_:int = 0;
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1004)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1004);
            }
            ...
            {
               this.var_117[int(_loc11_ / this.var_156)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_117.length * this.var_156 * this.var_78;
      }
      
      public function get usageCount() : int
      {
         return this.var_589.length;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_156 * this.var_78;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_589.indexOf(param1) == -1)
         {
      ...
      public function isUsedFromSong(param1:int) : Boolean
      {
         ...
         return this.var_589.indexOf(param1) != -1;
      }
   }
}
