package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1437:int = 60;
      
      private static const const_1436:int = 25165823;
      
      private static const const_1435:int = 16777215;
      ...
      private var var_958:Number = 1.0;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_926,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_960.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1151:
                  _loc3_ = "sound_call_for_help";
                  break;
               case HabboSoundTypesEnum.const_1916:
                  _loc3_ = "sound_guide_received_invitation";
                  break;
               case HabboSoundTypesEnum.const_1231:
                  _loc3_ = "sound_console_new_message";
                  break;
               case HabboSoundTypesEnum.const_1137:
               ...
               case HabboSoundTypesEnum.const_1216:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1668:
            ...
            this.var_960.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_958;
         _loc2_.play();
      }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_959.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_192.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2488 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_959 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_192 == null || this._connection == null || this._roomEngine == null || this.var_228 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1709,this.var_769));
         this.var_769 = -1;
         this.var_770 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_958 * 100)));
         }
      }
      ...
      {
         this.var_958 = param1;
         this.var_228.updateVolume(this.var_958);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         if(this.var_609.getValue(param1) != null)
         {
            ...
            if(this.var_260.getValue(_loc2_) == null)
            {
               ...
               param1.extract(this.var_1462,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1462,_loc2_,TraxSample.const_1856,TraxSample.const_1900);
      ...
      private function processLoadedSamples() : void
      {
         ...
         if(this.var_1178.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1437 && this.var_1178.length > 0)
            {
               _loc3_ = this.var_1178.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_609.length == 0 && this.var_769 != -1)
            {
               this.var_770.ready = true;
               _loc4_ = this.var_769;
               this.var_769 = -1;
               this.var_770 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_926,_loc4_));
               if(this.var_2488)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_770 == null && this.var_1177.length > 0)
         {
            ...
            if(_loc2_ != null && !_loc2_.disposed)
            {
               ...
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_926,_loc1_));
               }
               else
               {
                  this.var_770 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         if(_loc1_ > const_1436)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1435 && _loc9_ < _loc2_.length)
            {
