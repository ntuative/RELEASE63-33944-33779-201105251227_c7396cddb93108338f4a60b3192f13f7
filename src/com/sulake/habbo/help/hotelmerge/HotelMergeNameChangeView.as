package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_853)
         {
            this.var_853 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_853)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_854)
         {
            this.var_854 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_854)
            {
               return;
            }
