package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      private var var_63:WelcomeNotification;
      ...
      public function dispose() : void
      {
         if(this.var_183)
         {
            this.var_183.removeUpdateReceiver(this);
            this.var_183.toolbar.events.removeEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
            this.var_183 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_63 = param1;
         this.var_183.toolbar.events.addEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
         if(this._window == null)
         {
            this.initializeWindow();
         }
         var _loc2_:ITextWindow = ITextWindow(this._window.findChildByName("text"));
         _loc2_.caption = this.var_183.localization.getKey(param1.localizationKey);
         _loc2_.height = _loc2_.textHeight + 5;
         this.var_214.y = this.var_183.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
      ...
      {
         var _loc1_:XmlAsset = this.var_183.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_183.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
      ...
      {
         this.var_183.removeUpdateReceiver(this);
         this.var_183.registerUpdateReceiver(this,10);
      }
   }
}
