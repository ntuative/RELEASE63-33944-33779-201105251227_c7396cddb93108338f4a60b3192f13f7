package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_2041:uint = 11129827;
      ...
      private var var_2043:IWindowContainer;
      ...
      private var var_1309:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_2043 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_853)
         {
            this.var_853 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_853)
            {
               return;
            }
            this._window.content.addChild(this.var_853);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_854)
         {
            this.var_854 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_854)
            {
               return;
            }
            this._window.content.addChild(this.var_854);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_854.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_549;
         }
         this.showView(this.var_854);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_549);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_872:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_876:
         ...
         _loc5_.visible = true;
         this.var_1309 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1309.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_549 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_549);
               break;
