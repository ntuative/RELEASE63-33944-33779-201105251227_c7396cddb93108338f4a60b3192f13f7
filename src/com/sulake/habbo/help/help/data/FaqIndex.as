package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_833:FaqCategory;
      
      private var var_832:FaqCategory;
      ...
      public function FaqIndex()
      {
         ...
         this.var_833 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_832 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function dispose() : void
      {
         ...
         if(this.var_164 != null)
         {
            ...
            {
               _loc2_ = this.var_164.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
      ...
      {
         var _loc4_:FaqCategory = this.var_164.getValue(param1);
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_833.hasItem(param1))
         {
            this.var_833.getItem(param1).answerText = param2;
         }
         if(this.var_832.hasItem(param1))
         {
            this.var_832.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_164.length)
         {
            _loc4_ = this.var_164.getWithIndex(_loc3_);
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_833.hasItem(param1))
         {
            return this.var_833.getItem(param1);
         }
         if(this.var_832.hasItem(param1))
         {
            return this.var_832.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < this.var_164.length)
         {
            _loc3_ = this.var_164.getWithIndex(_loc2_);
