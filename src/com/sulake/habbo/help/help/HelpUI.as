package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1947:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201105251222));
         this.var_125 = new Map();
         this.var_125.add(HabboHelpViewEnum.const_1726,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_125.add(HabboHelpViewEnum.const_191,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_125.add(HabboHelpViewEnum.const_556,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_125.add(HabboHelpViewEnum.const_340,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_125.add(HabboHelpViewEnum.const_289,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_125.add(HabboHelpViewEnum.const_418,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_125.add(HabboHelpViewEnum.const_906,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_125.add(HabboHelpViewEnum.const_246,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_125.add(HabboHelpViewEnum.const_1269,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_125.add(HabboHelpViewEnum.const_1104,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_125.add(HabboHelpViewEnum.const_763,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_535.length == 0 || param1 != this.var_381)
            {
               this.var_535.push(this.var_381);
            }
         }
         this.var_381 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_381);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_246:
               ...
               break;
            case CallForHelpResultEnum.const_1105:
               this.showUI(HabboHelpViewEnum.const_1104);
               break;
            case CallForHelpResultEnum.const_1163:
               this.showUI(HabboHelpViewEnum.const_1269);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_125.getValue(HabboHelpViewEnum.const_191) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_490));
      }
      ...
      {
         return this.var_125.getValue(this.var_381);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2698 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2697;
         this._window.width = _loc1_.width + this.var_2698;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_535.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_381 == HabboHelpViewEnum.const_191)
         {
            return;
         }
         if(this.var_646.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_646.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_646[1],this.var_646[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_646[0],this.var_646[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_381 == HabboHelpViewEnum.const_191 || this.var_535.length == 0)
         {
            return;
         }
         if(this.var_382 == null)
