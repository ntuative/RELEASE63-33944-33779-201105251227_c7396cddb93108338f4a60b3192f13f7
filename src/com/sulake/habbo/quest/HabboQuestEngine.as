package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private var var_1125:QuestController;
      
      private var var_908:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1125 = new QuestController(this);
         this.var_908 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1360);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_377.events.removeEventListener(BadgeImageReadyEvent.const_110,this.var_908.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_377.events.addEventListener(BadgeImageReadyEvent.const_110,this.var_908.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1125.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_908.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1125.questTracker.isVisible();
      }
      ...
      {
         return this.var_192.getKey("questing.enabled","false") == "true";
      }
