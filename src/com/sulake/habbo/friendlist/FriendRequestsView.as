package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1947:String = "no_reqs_info";
      ...
      private var var_1715:IContainerButtonWindow;
      ...
      {
         this.var_1716 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1715 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1715.procedure = this.onDismissAllButtonClick;
         this.var_1716.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_344,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_386 && _loc4_.state != FriendRequest.const_375)
            {
               _loc4_.state = FriendRequest.const_375;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_344,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1715,_loc1_);
      }
