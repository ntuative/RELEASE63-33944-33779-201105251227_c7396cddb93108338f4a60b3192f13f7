package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_408:int = 100;
      ...
      {
         return Math.ceil(this.var_225.length / const_408);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_947 * const_408;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_947 + 1) * const_408,this.var_225.length);
      }
