package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2116:int = "F".charCodeAt(0);
      
      public static const const_2083:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_902 = param1.gender;
         this.var_743 = param1.online;
         this.var_1861 = param1.followingAllowed && param1.online;
         this.var_583 = param1.figure;
         this.var_1860 = param1.motto;
         this.var_1768 = param1.lastAccess;
         this.var_1405 = param1.categoryId;
         this.var_1767 = param1.realName;
