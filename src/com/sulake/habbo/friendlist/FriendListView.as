package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1404:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1760:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1760 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1404;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_907 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_272 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1760.prepare(this.var_907);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1292,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1244,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_816,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_809,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_816,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_809,true);
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1757 == -1 ? 0 : int(this.var_17.height - this.var_1757);
         var _loc4_:int = this.var_1758 == -1 ? 0 : int(this.var_17.width - this.var_1758);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_272.y = Util.getLowestPoint(this.var_17.content);
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1119,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_816,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1292,false);
         ...
         this.var_1757 = this.var_17.height;
         this.var_1758 = this.var_17.width;
