package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_136:IHabboMessenger;
      ...
      private var var_2506:FriendListLookAndFeel;
      
      private var var_419:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1817:OpenedToWebPopup;
      
      private var var_2398:int;
      
      var var_107:FriendCategories;
      
      private var _friendRequests:FriendRequests;
      
      private var var_1818:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_959:IHabboNotifications;
      
      private var var_611:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2506 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_107 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1818 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_136)
         {
            this.var_136.release(new IIDHabboMessenger());
            this.var_136 = null;
         }
         if(this.var_192)
         {
         ...
         if(this.var_921)
         {
            this.var_921.release(new IIDAvatarRenderManager());
            this.var_921 = null;
         }
         if(this.var_959)
         {
            this.var_959.release(new IIDHabboNotifications());
            this.var_959 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_771)
         {
            this.var_771.release(new IIDSessionDataManager());
            this.var_771 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1817 = new OpenedToWebPopup(this);
         }
         this.var_1817.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_107.findFriend(param1);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_395);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_107.getFriendCount(param1,param2);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_317,HabboWindowStyle.const_48,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_921.createAvatarImage(param1,AvatarScaleType.const_92,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_136 = param2 as IHabboMessenger;
      ...
      {
         this.var_959 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_107.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_107.addCategory(new FriendCategory(FriendCategory.const_1282,this.getText("friendlist.friends")));
         this.var_107.addCategory(new FriendCategory(FriendCategory.const_416,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_107.addFriend(new Friend(_loc4_));
         }
         this.var_419 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_611)
         {
         ...
         if(this.var_107.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_107.findCategory(FriendCategory.const_416);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_419.findTab(FriendListTab.const_100).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_419.findTab(FriendListTab.const_100);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1818.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_107.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_107.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_419.findTab(FriendListTab.const_100);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_771 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_771.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_771.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_42))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(disposed || this.var_107 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_107.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
