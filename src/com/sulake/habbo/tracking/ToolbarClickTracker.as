package com.sulake.habbo.tracking
{
   ...
   public class ToolbarClickTracker
   {
      ...
      private var var_1373:IHabboTracking;
      ...
      public function configure(param1:IHabboConfigurationManager) : void
      {
         ...
         this.var_2407 = parseInt(param1.getKey("toolbar.tracking.max.events","100"));
      }
      ...
      public function track(param1:String) : void
      {
         ...
         ++this.var_1762;
         if(this.var_1762 <= this.var_2407)
         {
            this.var_1373.track("toolbar",param1);
         }
      }
   }
}
