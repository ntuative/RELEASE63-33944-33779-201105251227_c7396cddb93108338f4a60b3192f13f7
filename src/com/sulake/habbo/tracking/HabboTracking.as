package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1087:uint = 11;
      ...
      private var var_1305:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_183:IHabboHelp;
      ...
      private var var_461:FramerateTracker = null;
      
      private var var_278:LatencyTracker = null;
      
      private var var_675:LagWarningLogger = null;
      
      private var var_462:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_461 = new FramerateTracker();
         this.var_278 = new LatencyTracker();
         this.var_675 = new LagWarningLogger();
         this.var_462 = new ToolbarClickTracker(this);
         this.var_1579 = new Array(const_1087);
         var _loc4_:int = 0;
         while(_loc4_ < const_1087)
         {
            this.var_1579[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1697,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1643,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1868,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_969,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1235,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1305)
            {
               this.var_1305.release(new IIDHabboWindowManager());
               this.var_1305 = null;
            }
            if(this.var_310)
            {
            ...
            if(this.var_215)
            {
               if(!this.var_215.disposed)
               {
                  ...
                  Component(this.var_215).events.removeEventListener(HabboFriendListTrackingEvent.const_481,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_183)
            {
               ...
               {
                  this.var_183.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_183.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_183.release(new IIDHabboHelp());
               this.var_183 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_330,this.onRoomAction);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_192)
         {
            if(this.var_278 != null)
            {
               this.var_278.configuration = this.var_192;
            }
            if(this.var_279 != null)
            {
               this.var_279.configuration = this.var_192;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1698);
            if(this.var_192)
            {
               if(this.var_675 != null)
               {
                  this.var_675.configure(this.var_192);
               }
               if(this.var_461 != null)
               {
                  this.var_461.configure(this.var_192);
               }
               if(this.var_462 != null)
               {
                  this.var_462.configure(this.var_192);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_769,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_978,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_68,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_620,this.onHotelViewEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_978)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1740);
         }
         else if(param1.type == HabboHotelViewEvent.const_620)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1821);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_769:
               this.trackLoginStep(HabboLoginTrackingStep.const_1639,String(this._communication.port));
               break;
      ...
      {
         this.var_1305 = IHabboWindowManager(param2);
         if(this.var_1305)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_192)
            {
               if(this.var_192.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1579)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1228);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1228,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_215).events.addEventListener(HabboFriendListTrackingEvent.const_481,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_481:
      ...
      {
         this.var_183 = param2 as IHabboHelp;
         this.var_183.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_183.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1235,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_969,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_330,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_310 = param2 as IAdManager;
         this.var_310.events.addEventListener(AdEvent.const_588,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_322)
         {
            if(this.var_2036 < 1)
            {
               if(!this.var_327)
         ...
         else if(param1.type == RoomEngineEvent.const_330)
         {
            if(this.var_327)
            {
               this.var_327.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_461)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_461.frameRate),_loc2_);
                  ++this.var_2036;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_462)
         {
            this.var_462.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_462)
         {
            this.var_462.track(param1.type);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_547 > -1 && _loc2_ < this.var_547)
         {
            ++this.var_2034;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2034);
         }
         if(this.var_547 > -1 && _loc2_ - this.var_547 > 15000)
         {
            ++this.var_2035;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2035);
         }
         this.var_547 = _loc2_;
         if(this.var_279 != null)
         {
            this.var_279.update(param1,this.var_547);
         }
         if(this.var_278 != null)
         {
            this.var_278.update(param1,this.var_547);
         }
         if(this.var_461 != null)
         {
            this.var_461.trackUpdate(param1,this,this.var_547);
         }
         if(this.var_675 != null)
         {
            this.var_675.update(this.var_547);
         }
      }
   }
}
