package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2242:int = 10;
      ...
      private const const_1978:uint = 4.293848814E9;
      
      private const const_1977:uint = 4.294967295E9;
      
      private const const_1579:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1283 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_324,this.onNameInputKeyUp);
         }
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_321,this.onMessageInputFocus);
         }
         this.var_1991 = true;
         this.var_1990 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               _loc12_.addEventListener(WindowEvent.const_560,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1989 = _loc1_.stuffTypes;
            this.var_837 = _loc1_.boxTypes;
            this.var_838 = _loc1_.ribbonTypes;
            this.var_1284 = this.var_1989[0];
            this.var_386 = this.var_837[0];
            this.var_387 = this.var_838[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_387 < 0)
         {
            this.var_387 = this.var_838.length - 1;
         }
         if(this.var_387 > this.var_838.length - 1)
         {
            this.var_387 = 0;
         }
         if(this.var_386 < 0)
         {
            this.var_386 = this.var_837.length - 1;
         }
         if(this.var_386 > this.var_837.length - 1)
         {
            this.var_386 = 0;
         }
         var _loc1_:int = this.var_837[this.var_386] * 1000 + this.var_838[this.var_387];
         if(this._window == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1989)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_837[this.var_386]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_838[this.var_387]);
         this._catalog.purchaseProductAsGift(this.var_1561,this.var_1283,this.var_1560,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1561,this.var_1283,this.var_1560);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         for each(_loc5_ in this.var_225)
         {
            ...
            if(_loc4_.length >= this.const_2242)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2763 = _loc2_.text;
      }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_276 == null || this.var_839 == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1579;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1978) : uint(this.const_1977);
      }
