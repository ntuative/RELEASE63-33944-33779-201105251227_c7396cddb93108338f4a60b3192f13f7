package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1088:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_208:IItemGrid;
      
      protected var _icon:IBitmapWrapperWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_529:Object;
      ...
      {
         this._view.getChildByName(const_1088).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1088).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_86,MouseCursorType.const_795);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_795);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_208.select(this);
            this.var_529 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_529 != null && this.var_529 == param2)
         {
            _loc3_ = this.var_208.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_529 = null;
            }
