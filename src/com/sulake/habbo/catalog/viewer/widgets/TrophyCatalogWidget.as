package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1524:int = 16763904;
      
      private static const const_1522:int = 13421772;
      ...
      override public function init() : Boolean
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(this.var_274.getValue(_loc5_) == null)
            {
               this.var_274.add(_loc5_,new Map());
            }
            _loc7_ = this.var_274.getValue(_loc5_) as Map;
            _loc7_.add(_loc6_,_loc3_);
         }
         _loc4_ = this.var_274.getWithIndex(this.var_323);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_826);
            if(_loc3_ == null)
            {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_274.getWithIndex(this.var_323);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_826);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_323;
         if(this.var_323 >= this.var_274.length)
         {
            this.var_323 = 0;
         }
         var _loc2_:Map = this.var_274.getWithIndex(this.var_323);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_323 < 0)
         {
            this.var_323 = this.var_274.length - 1;
         }
         var _loc2_:Map = this.var_274.getWithIndex(this.var_323);
         if(_loc2_ != null)
         {
