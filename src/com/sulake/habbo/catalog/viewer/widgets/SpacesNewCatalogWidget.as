package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_419:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer)
      {
         ...
         super(param1);
         this.var_419 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_419)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_419.numSelectables)
            {
               _loc3_ = this.var_419.getSelectableAt(_loc2_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_107[this.var_507]);
      ...
      public function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         var _loc3_:Offer = this.var_205[this.var_507][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_488.numGridItems)
         {
            _loc2_ = this.var_205[this.var_507][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_668[this.var_507] = (this.var_205[this.var_507] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_399 || _loc1_.pricingModel == Offer.const_420))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_419.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_419.setSelected(this.var_419.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            if(var_488)
            {
               var_488.destroyGridItems();
            }
            page.replaceOffers(this.var_205[this.var_507],false);
            resetTimer();
            populateItemGrid();
