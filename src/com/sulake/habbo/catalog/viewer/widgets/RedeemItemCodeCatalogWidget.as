package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_974.removeEventListener(WindowKeyboardEvent.const_215,this.windowKeyEventProcessor);
            this.var_974 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_974 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_974 != null)
         {
            this.var_974.addEventListener(WindowKeyboardEvent.const_215,this.windowKeyEventProcessor);
         }
         return true;
      }
