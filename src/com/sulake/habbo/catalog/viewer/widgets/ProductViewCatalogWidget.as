package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1932:Point;
      
      private var var_533:IItemGridWindow;
      
      private var var_1533:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1004 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1246 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_89 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1932 = new Point(this.var_89.x,this.var_89.y);
         this.var_533 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1533 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1931 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1004.text = _loc4_;
         this.var_1246.text = _loc5_;
         this.var_1004.height = this.var_1004.textHeight + 5;
         this.var_1246.y = this.var_1004.y + this.var_1004.height;
         this.var_1246.height = Math.max(130,this.var_1246.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_614:
                  _loc6_ = this.var_1931.clone();
                  if(this.var_533 != null)
                  {
                     this.var_533.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_533,this.var_1533,this.var_1973);
                     ...
                     case ProductTypeEnum.const_193:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_342,AvatarAction.const_583);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2687)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2687 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_89 != null && true)
         {
            ...
            this.var_89.x = this.var_1932.x;
            this.var_89.y = this.var_1932.y;
            if(param3 != null)
            {
