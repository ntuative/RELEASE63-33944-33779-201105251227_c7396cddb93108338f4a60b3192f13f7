package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_2454:XML;
      
      private var var_2453:XML;
      ...
      private var var_2993:IButtonWindow;
      
      private var var_1790:ITextWindow;
      
      private var var_1789:ITextWindow;
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_680,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2454 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2453 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2452 = _loc3_.content as XML;
         }
         var _loc4_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsOrCreditsAndPixelsStub") as XmlAsset;
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.const_680,this.onSetParameter);
      ...
      private function attachStub(param1:String) : void
      {
         ...
         switch(param1)
         {
            case Offer.const_773:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2454) as IWindowContainer;
               break;
            case Offer.const_1198:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2453) as IWindowContainer;
               break;
            case Offer.const_1266:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2452) as IWindowContainer;
               break;
            default:
         ...
         this.var_1789 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         ...
         if(this.var_608 != null)
         {
            ...
            {
               this.var_608.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1459);
            }
            else
            {
               this.var_608.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1459);
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         var _loc3_:String = this.var_95.activityPointType == ActivityPointTypeEnum.PIXEL ? "pixels" : "activitypoints";
         if(this.var_1789 != null)
         {
            ...
            this.var_1789.caption = _loc2_.getKey(_loc4_);
         }
      ...
      {
         this.var_1792 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         if(this.var_95 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_95,page.pageId,this.var_1792);
         }
      }
      ...
      private function initPurchase(param1:CatalogWidgetInitPurchaseEvent) : void
      {
         if(this.var_95 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_95,page.pageId,this.var_1792,param1.enableBuyAsGift);
         }
      }
   }
}
