package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      {
         var _loc2_:Offer = this.var_205[this.var_507][this.var_668];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_507 = var_488.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_507];
         var _loc3_:Array = this.var_205[this.var_507] as Array;
      ...
      {
         var _loc2_:Array = this.var_205[this.var_507] as Array;
      ...
      private function updateGridWithSelectedColour() : void
      {
         ...
         var _loc1_:Array = this.var_205[this.var_507] as Array;
         var _loc2_:Offer = _loc1_[this.var_668] as Offer;
         var_221 = _loc2_.productContainer as ProductGridItem;
         var_221.activate();
      }
