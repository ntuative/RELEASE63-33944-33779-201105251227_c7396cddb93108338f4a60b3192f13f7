   ...
   public class RoomPreviewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IDragAndDropDoneReceiver
   {
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_529 != null && this.var_529 == param2)
         {
            if(this.var_95)
            {
               (page.viewer.catalog as HabboCatalog).requestSelectedItemToMover(this,this.var_95);
               this.var_529 = null;
            }
         }
      ...
      private function onUpdateRoomPreview(param1:CatalogWidgetUpdateRoomPreviewEvent) : void
      {
         ...
         {
            this.var_1693 = _loc3_.id;
            this.var_1692 = _loc4_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_350 != null && this._imageStoreWindow != null)
         {
            this.setRoomImage(this.var_350,this._imageStoreWindow);
         }
      }
   }
}
