package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_221:IGridItem;
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_843,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_260,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_758,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_245,this.deActivateScrollbar);
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_210.stop();
            this.var_210.removeEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_210 = null;
         }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_488 = _window.findChildByName("itemGrid") as IItemGridWindow;
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1973 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_199)
         {
            this.var_210 = new Timer(25);
            this.var_210.addEventListener(TimerEvent.TIMER,this.loadItemGridGraphics);
            this.var_210.start();
         }
         else
         {
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_864 >= 0 && this.var_864 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_864];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         if(param1.pricingModel == Offer.const_614)
         {
            ++this.var_2092;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_2092);
         }
      }
