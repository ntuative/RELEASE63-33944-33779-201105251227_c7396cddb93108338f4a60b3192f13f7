package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2622 = _loc3_.localizationId;
         this.var_397 = [];
         if(page && false && page.viewer.catalog)
         {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         this.var_555 = param1.index;
         if(this.var_555 < 0 || this.var_555 > this.var_397.length)
         {
            this.var_555 = 0;
         }
         this.updateImage();
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_217 == null || this.var_860 >= this.var_217.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_555 >= 0 && this.var_555 < this.var_397.length)
         {
            _loc7_ = this.var_397[this.var_555] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_217[this.var_860] as int;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_526,_loc3_,_loc2_,AvatarScaleType.const_55,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_342,AvatarAction.const_819);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_555 >= this.var_397.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_397[this.var_555] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_217[this.var_860] as int;
