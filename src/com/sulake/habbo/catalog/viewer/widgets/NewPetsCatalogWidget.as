package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1489:int = 18;
      ...
      override public function init() : Boolean
      {
         ...
         events.addEventListener(WidgetEvent.const_857,this.onApproveNameResult);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_217 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1489 && _loc2_ < this.var_217.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_526,this.var_217[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_217 != null && this.var_217.length > 0)
         {
            ...
            this.var_375 = this.var_217[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_526,this.var_375),this.getRaceLocalizationKey(this.var_526,this.var_375));
            }
         }
         return this.getRaceLocalizationKey(this.var_526,this.var_375);
      }
      ...
      {
         if(param1.productCode == this.var_2622)
         {
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_375 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_526;
         var _loc3_:int = this.var_375;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_375 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
