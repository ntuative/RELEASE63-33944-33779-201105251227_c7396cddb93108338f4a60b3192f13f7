package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1934:String = "ctlg_";
       
      
      protected var var_2167:XML;
      ...
      {
         return this._localization.getLinks(this.var_1248);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1248);
      }
      ...
      {
         var _loc2_:String = const_1934 + param1;
         ...
         this.var_2167 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2167) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1896:
               if(this.var_1247 == null)
               {
                  this.var_1247 = new ItemGridCatalogWidget(param1);
                  this.var_37.push(this.var_1247);
               }
               break;
            case CatalogWidgetEnum.const_1685:
               this.var_37.push(new ItemGroupCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1690:
            ...
            case CatalogWidgetEnum.const_1878:
               ...
               break;
            case CatalogWidgetEnum.const_1839:
