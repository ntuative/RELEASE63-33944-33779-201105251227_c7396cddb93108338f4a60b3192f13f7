package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      public function showConfirmation() : void
      {
         ...
         if(!this.var_95.productContainer)
         {
            return;
         }
         this.var_95.productContainer.view = _loc2_;
         this.var_95.productContainer.initProductIcon(this._controller.roomEngine);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "select_button":
               this._controller.confirmSelection(this.var_95.localizationId);
               break;
