package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_661:uint = 1;
      ...
      private var var_1164:IRoomSession;
      ...
      private var var_209:ChargeConfirmationDialog;
      ...
      private var var_2640:Boolean = true;
      
      private var var_2641:Boolean = true;
      
      private var var_1901:Boolean = false;
      
      private var var_2642:GiftWrappingConfiguration;
      
      private var var_1230:ClubGiftController;
      ...
      private var var_809:IPurchasableOffer;
      
      private var var_1518:IDragAndDropDoneReceiver;
      
      private var var_59:PlacedObjectPurchaseData;
      
      private const const_1971:Point = new Point(100,20);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1759);
               return;
            }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_148,this.onObjectPlaced);
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_192.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_661) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_1971;
         this.hideMainWindow();
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1230 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_808 && this.var_808 != "")
         {
            this.var_376.openPage(this.var_808);
            this.var_808 = "";
            this.var_994 = -1;
         }
         else if(this.var_994 > -1)
         {
            this.var_376.openPageById(this.var_994,this.var_1902);
            this.var_994 = -1;
            this.var_1902 = -1;
            this.var_808 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2640 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1216);
         }
         this.var_2640 = false;
         if(this.var_209 != null && !this.var_209.disposed)
         {
            this.var_209.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_70,this.var_110.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2641 && this._soundManager != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1230.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2642 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_209 == null || this.var_209.disposed)
         {
            this.var_209 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_209.showChargeInfo(_loc2_);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_192.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
      ...
      {
         if(!this.var_192.keyExists("catalog.drag_and_drop") || this.var_192.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1164 || !this.var_1164.isRoomOwner)
         {
            return false;
         }
      ...
      private function updateRoom(param1:String, param2:String) : void
      {
         ...
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_216);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1231 && param1.type == RoomEngineObjectEvent.const_148)
         {
            this.resetPlacedOfferData(true);
            if(this.var_809 == null || this.var_809.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_809.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_59 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_809);
            _loc5_ = this.var_1518;
            if(_loc5_ != null)
            {
            ...
            if(this.var_59.roomCategory == this._roomEngine.activeRoomCategory && this.var_59.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  case FurniCategory.const_311:
                     _loc8_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_216);
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_661);
            if(_loc1_ != null)
            {
