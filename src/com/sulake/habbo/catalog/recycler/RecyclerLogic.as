package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_699 != const_1098;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2111 != RecyclerStatusMessageEvent.const_1273;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_699 == const_462;
      }
      ...
      {
         this.var_699 = const_1099;
         this.var_130 = new Array(const_220);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_220)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_699 = const_1098;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_2111)
         {
            case RecyclerStatusMessageEvent.const_1770:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1273:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1652:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1274:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1750:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_130.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_220)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_130.length < const_220)
         {
            return false;
         }
         var _loc1_:int = 0;
