package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_228.events.addEventListener(NowPlayingEvent.const_99,this.onNowPlayingChanged);
            this.var_228.events.addEventListener(SongInfoReceivedEvent.const_91,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_110,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_110,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_228 != null)
         {
            this.var_228.events.removeEventListener(NowPlayingEvent.const_99,this.onNowPlayingChanged);
            this.var_228.events.removeEventListener(SongInfoReceivedEvent.const_91,this.onSongInfoReceivedEvent);
            this.var_228 = null;
         }
         this.var_1092 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_574);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_846);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_920);
         _loc1_.push(RoomWidgetFurniActionMessage.const_700);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1278);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_899);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_692);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_895);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1810);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_440 || param1.type == RoomWidgetUserActionMessage.const_580 || param1.type == RoomWidgetUserActionMessage.const_523)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_574:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_846:
            ...
            case RoomWidgetUserActionMessage.const_440:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_899:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_692:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_895:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_238);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_389) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_389);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_909) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1152;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_238);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1156);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_537)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_431) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_431.length);
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_609)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_575);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_118)
               {
                  _loc14_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_142)
               {
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_955;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_779;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1684);
               }
               else
               {
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_228 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_421,_loc2_,_loc3_,_loc4_));
         }
      }
