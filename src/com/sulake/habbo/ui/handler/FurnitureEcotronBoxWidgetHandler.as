package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_865,RoomWidgetEcotronBoxOpenMessage.const_714,RoomWidgetEcotronBoxOpenedMessage.const_1696];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_865:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_714:
