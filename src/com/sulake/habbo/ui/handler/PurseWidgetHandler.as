package com.sulake.habbo.ui.handler
{
   ...
   public class PurseWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            this._container.catalog.events.removeEventListener(PurseEvent.const_70,this.purseEventHandler);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         {
            this._container.catalog.events.addEventListener(PurseEvent.const_70,this.purseEventHandler);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetPurseData.const_687);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_687:
               _loc2_ = this._container.catalog.getPurse();
               this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_70,_loc2_.credits));
            ...
            case RoomWidgetOpenCatalogMessage.const_388:
               ...
               if(this._container.catalog != null)
               {
                  ...
                  {
                     case RoomWidgetOpenCatalogMessage.const_1226:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1742);
                        break;
                     case RoomWidgetOpenCatalogMessage.const_1172:
      ...
      private function purseEventHandler(param1:PurseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case PurseEvent.const_70:
               _loc2_ = new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_70,param1.balance);
               break;
