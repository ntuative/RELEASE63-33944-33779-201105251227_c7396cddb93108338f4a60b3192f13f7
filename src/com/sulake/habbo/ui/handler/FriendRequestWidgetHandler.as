package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFriendRequestMessage.const_966);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_828);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_869:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_966:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_828:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_160);
         _loc1_.push(FriendRequestEvent.const_62);
         _loc1_.push(FriendRequestEvent.const_344);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_160:
            ...
            case FriendRequestEvent.const_344:
