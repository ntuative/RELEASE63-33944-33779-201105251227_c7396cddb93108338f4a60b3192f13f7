package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1683:Map = null;
      
      private var var_1127:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1126:Number = 0.0;
      
      private var var_727:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_412 != null)
         {
            ...
            {
               _loc2_ = this.var_412.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_292 != null)
         {
            ...
            {
               _loc2_ = this.var_292.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1127)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_942,RoomWidgetChatSelectAvatarMessage.const_787];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_942:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_42) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1205))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_42) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1205))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_787:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_292.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_412.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_586.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_586.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_221)
                                    {
                                       this.var_292.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_412.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1126 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1126);
            }
            if(this.var_727 == null)
            {
               ...
               this.var_493.y = 0;
               this.var_493.z = 0;
               this.var_727 = _loc4_.getScreenPoint(this.var_493);
               this.var_1126 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_493.x = 0;
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_727.x || _loc8_.y != this.var_727.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_727,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_292)
         {
            _loc2_ = this.var_292.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1127.push(_loc2_);
            }
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_412)
         {
            _loc2_ = this.var_412.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1127.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_586.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1683.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1683.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_292)
            {
               this.var_292.add(_loc3_,param2);
            }
         }
      }
   }
