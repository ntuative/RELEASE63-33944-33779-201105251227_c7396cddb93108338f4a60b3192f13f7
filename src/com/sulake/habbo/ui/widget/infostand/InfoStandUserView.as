package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_891:TagListRenderer;
      
      private var var_149:IBorderWindow;
      
      private var var_2883:int;
      
      private var var_2882:Boolean = true;
      
      private const const_1094:int = 5;
      
      private const const_2251:int = 3;
      
      private const const_1605:int = 11184810;
      
      private const const_1606:int = 16777215;
      
      private const const_2249:int = 2000;
      
      private const const_2250:int = 50;
      
      private const const_2252:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_891 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2882 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      {
         if(this.var_51 == null || this.var_47 == null || this.var_101 == null)
         {
            return;
         }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_149.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_149.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_149.x = _loc5_.left - this.var_149.width;
         this.var_149.y = _loc5_.top + (_loc5_.height - this.var_149.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_149.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_149.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_149.x = _loc7_.left - this.var_149.width;
         this.var_149.y = _loc7_.top + (_loc7_.height - this.var_149.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_149 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_149 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1094;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1605;
            }
            else
            {
               _loc5_.textColor = this.const_1606;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1094,this.const_2250);
         _loc5_.height = Math.max(_loc5_.height,this.const_2252);
         _loc3_.height = _loc5_.height + this.const_2251;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_324,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_324,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_891.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_955:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_779:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2883 > this.const_2249 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2883 = _loc6_;
               _loc3_.textColor = this.const_1606;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1605;
         }
      }
