package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1981:String = "infostand_user_view";
      
      private const const_1986:String = "infostand_furni_view";
      
      private const const_1982:String = "infostand_pet_view";
      
      private const const_1984:String = "infostand_bot_view";
      
      private const const_1985:String = "infostand_jukebox_view";
      
      private const const_1983:String = "infostand_songdisk_view";
      
      private var var_1332:InfoStandFurniView;
      
      private var var_194:InfoStandUserView;
      
      private var var_400:InfoStandPetView;
      
      private var var_472:InfoStandBotView;
      
      private var var_1074:InfoStandJukeboxView;
      
      private var var_1073:InfoStandSongDiskView;
      
      private var var_2874:Array;
      
      private var var_1608:InfostandUserData;
      ...
      private const const_2248:int = 3000;
      ...
      public function InfostandWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboCatalog)
      {
         ...
         this.var_1332 = new InfoStandFurniView(this,this.const_1986,this._catalog);
         this.var_194 = new InfoStandUserView(this,this.const_1981);
         this.var_400 = new InfoStandPetView(this,this.const_1982,this._catalog);
         this.var_472 = new InfoStandBotView(this,this.const_1984);
         this.var_1074 = new InfoStandJukeboxView(this,this.const_1985,this._catalog);
         this.var_1073 = new InfoStandSongDiskView(this,this.const_1983,this._catalog);
         this.var_1608 = new InfostandUserData();
         this.var_591 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_173 = new Timer(this.const_2248);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_83,HabboWindowStyle.const_48,HabboWindowParam.const_48,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_834,this.onRoomObjectSelected);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_892,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_834,this.onRoomObjectSelected);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_892,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_440,this.var_400.getCurrentPetId()));
      }
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1981);
         if(this.var_173)
         {
            this.var_173.stop();
         }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_431) != -1)
         {
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1982);
         if(this.var_173)
         {
            this.var_173.start();
         }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_194.setTags(param1.tags,this.var_2874);
         }
      }
      ...
      private function onUserFigureUpdate(param1:RoomWidgetUserFigureUpdateEvent) : void
      {
         ...
         {
            this.var_472.image = param1.image;
         }
         else
         {
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(this.userData.isBot())
            {
               this.var_472.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      {
         var _loc2_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_574,param1.id,param1.category);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_179:
               ...
               {
                  _loc2_ = param1.id == this.var_1608.userRoomId;
                  break;
               }
               ...
               if(this.var_472 != null && this.var_472.window != null && this.var_472.window.visible)
               {
                  _loc2_ = param1.id == this.var_1608.userRoomId;
                  break;
               }
