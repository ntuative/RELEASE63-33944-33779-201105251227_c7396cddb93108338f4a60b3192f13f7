package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1464:int = 152;
      
      private static const const_1470:int = 16;
      
      private static const const_655:int = 4;
      
      private static const const_1469:uint = 14342874;
      
      private static const const_1466:uint = 3815994;
      
      private static const const_1465:uint = 2085362;
      
      private static const const_1462:uint = 39616;
      
      private static const const_1468:uint = 10513106;
      
      private static const const_1473:uint = 8734654;
      
      private static const const_1463:uint = 9094430;
      
      private static const const_1467:uint = 6200576;
      
      private static const const_1460:String = "happiness";
      
      private static const const_1461:String = "experience";
      
      private static const const_1472:String = "energy";
      
      private static const const_1471:int = 250;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1460,param1.nutrition,param1.nutritionMax,const_1462,const_1465);
         this.updateStateElement(const_1461,param1.experience,param1.experienceMax,const_1473,const_1468);
         this.updateStateElement(const_1472,param1.energy,param1.energyMax,const_1467,const_1463);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1464,const_1470,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1469);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1466);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_655,_loc7_.width - 2,_loc7_.height - 2 - const_655);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_655);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_543) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_206 && this.var_206.getPetId() == this.var_543)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1624,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_443,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1049 + const_1048;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1048;
            }
         }
         this.var_101.height = _loc4_ + const_1049;
         this.updateWindow();
      }
   }
}
