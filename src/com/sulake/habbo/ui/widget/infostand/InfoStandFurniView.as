package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc5_.name)
         {
            ...
            case "save_branding_configuration":
               break;
            case "HabboQuestEngineCom_AchievementCategory":
               _loc3_ = "null";
         }
         if(_loc3_ != null)
         {
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1152 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_537 && param1.isRoomOwner)
         {
         ...
         this.showButton("HabboQuestEngineCom_AchievementCategory",_loc6_);
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1308.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
