package com.sulake.habbo.ui.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_1080:String = "Boy";
      
      private static const const_1079:String = "Girl";
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         this.var_2406 = param1.objectCategory;
         ...
         this._window = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_83,HabboWindowStyle.const_48,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
         ...
         _loc4_ = this._window.findChildByName(const_1079);
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onGenderSelectionMouseEvent);
         }
      ...
      private function hideEditorInterface() : void
      {
         ...
         {
            _loc1_ = this.var_845 as IFrameWindow;
            if(_loc1_ != null)
            {
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         _loc5_.setParamFlag(HabboWindowParam.const_205,true);
         this.var_845 = _loc4_;
         this.var_845.offset(100,100);
         var _loc6_:IWindow = this.var_845.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = this.onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_393,param1,this.var_220,this.var_2406,this._roomId,this._roomCategory,_loc5_);
