package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_642:String = "welcome_gift_email_unverified";
      
      private const const_1003:String = "welcome_gift_email_verified";
      
      private const const_1366:String = "welcome_gift_email_change";
      
      private const const_2214:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1134)
         {
            this.setViewState(this.const_1003);
         }
         else
         {
            this.setViewState(this.const_642);
         }
      }
      ...
      {
         this.setViewState(this.const_1366);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_793,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1134 ? this.const_1003 : this.const_642);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1420 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1420));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_739,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_739,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_477:
               this.var_1419 = param1.email;
               this.var_1134 = param1.isVerified;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1419 = this.var_1420;
            this.setViewState(this.const_642);
         }
         else
         {
            if(param1.result == this.const_2214)
            {
               this.var_917 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1420);
