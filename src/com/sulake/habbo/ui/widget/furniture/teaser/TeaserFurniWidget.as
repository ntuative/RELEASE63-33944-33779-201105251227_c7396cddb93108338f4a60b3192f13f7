package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1962:int = 0;
      
      private const const_1961:int = 1;
      
      private const const_1964:int = 2;
      
      private const const_1963:int = 3;
      
      private const const_1960:int = 4;
      
      private const const_2227:int = 0;
      
      private const const_2234:int = 1;
      
      private const const_2231:int = 2;
      
      private const const_2228:int = 3;
      
      private const const_2229:int = 4;
      
      private const const_2226:int = 5;
      
      private const const_1958:String = "deco_img";
      
      private const const_1959:String = "dialog_bg";
      
      private const const_2232:String = "%campaign%_dialog_bg.png";
      
      private const const_366:String = "%campaign%_gift_package.png";
      
      private const const_2230:String = "%campaign%_gift_content.png";
      
      private const const_2233:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1500 = this.var_144.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1500 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1498.length)
         {
            _loc2_ = this.var_1498.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_144 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_529,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_856,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_529,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_529:
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_696:
               ...
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_856:
               _loc2_ = this.const_1961;
               this.var_220 = param1.objectId;
         ...
         if(this._window && (this.var_1499 != _loc2_ || _loc3_ != this.var_184))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1499)
            {
               ...
               case this.const_1961:
                  if(this.var_407 == this.const_2227)
                  {
                  ...
                  else if(this.var_407 == this.const_2234)
                  {
                     ...
                     _loc2_ = this.const_2230;
                  }
                  else if(this.var_407 == this.const_2231)
                  {
                  ...
                  else if(this.var_407 == this.const_2228)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_407 == this.const_2229)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_184,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_407 == this.const_2226)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2232.replace("%campaign%",this.var_184);
            this.setDecoImage(_loc5_,this.const_1959);
            _loc2_ = _loc2_.replace("%campaign%",this.var_184);
            this.setDecoImage(_loc2_,this.const_1958);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_736);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_183);
            _loc2_.objectId = this.var_220;
            messageListener.processWidgetMessage(_loc2_);
         }
         this.hideInterface();
         if(this.var_13)
         {
            if(this.var_1497 != 0)
            {
               this.var_13.toggleInventoryPage(this.var_1497 == 1 ? "null" : InventoryCategory.const_130);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_950,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1498.push(new ImageDownloader(this,_assets,this.var_184,this.var_1500,param1,param2));
            return;
         }
