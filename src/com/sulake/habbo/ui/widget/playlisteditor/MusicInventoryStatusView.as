package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_441[param1] as IWindowContainer,0);
         this.var_44 = param1;
      }
      ...
      public function method_9(param1:BitmapData, param2:Boolean = true) : void
      {
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_441.add(const_754,_loc1_);
            this.var_1783 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1782 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_509));
         ...
         if(_loc1_ != null)
         {
            this.var_441.add(const_889,_loc1_);
            ...
            this.method_9(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_619));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_441[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
