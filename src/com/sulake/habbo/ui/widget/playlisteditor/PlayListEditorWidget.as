package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListEditorWidget extends RoomWidgetBase
   {
      ...
      private static const const_1615:int = 100;
      
      private static const const_1618:int = 130;
      
      private static const const_1617:int = 100;
      ...
      {
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_698,this.onShowPlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_985,this.onHidePlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_818,this.onInventoryUpdatedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_727,this.onSongDiskInventoryUpdatedEvent);
         ...
         param1.addEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_99,this.onNowPlayingChangedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_127,this.onNowPlayingChangedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_116,this.onNowPlayingChangedEvent);
      }
      
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_698,this.onShowPlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_985,this.onHidePlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_818,this.onInventoryUpdatedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_727,this.onSongDiskInventoryUpdatedEvent);
         ...
         param1.removeEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_99,this.onNowPlayingChangedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_127,this.onNowPlayingChangedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorNowPlayingEvent.const_116,this.onNowPlayingChangedEvent);
      }
      ...
      public function getDiskColorTransformFromSongData(param1:String) : ColorTransform
      {
         ...
         _loc2_ = uint(_loc2_ % const_1614 + const_1619);
         _loc3_ = uint(_loc3_ % const_1615 + const_1616);
         _loc4_ = uint(_loc4_ % const_1617 + const_1618);
      ...
      public function sendAddToPlayListMessage(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc4_ = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_951,_loc3_,param1);
      ...
      {
         var _loc2_:RoomWidgetPlayListModificationMessage = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_953,param1);
         if(messageListener != null)
         {
      ...
      public function sendTogglePlayPauseStateMessage() : void
      {
         ...
         var _loc2_:RoomWidgetPlayListPlayStateMessage = new RoomWidgetPlayListPlayStateMessage(RoomWidgetPlayListPlayStateMessage.const_811,this._furniId,_loc1_);
         if(messageListener != null)
         {
            messageListener.processWidgetMessage(_loc2_);
         }
      ...
      public function playUserSong(param1:int) : void
      {
         ...
         this._soundManager.musicController.playSong(param1,HabboMusicPrioritiesEnum.const_394,0,0,0,0);
      }
      
      public function stopUserSong() : void
      {
         this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_394);
      }
      ...
      {
         var _loc1_:RoomWidgetPlayListUserActionMessage = new RoomWidgetPlayListUserActionMessage(RoomWidgetPlayListUserActionMessage.const_717);
         if(messageListener != null)
         {
            messageListener.processWidgetMessage(_loc1_);
         }
         this._catalog.openCatalogPage(CatalogPageName.const_1682,true);
      }
