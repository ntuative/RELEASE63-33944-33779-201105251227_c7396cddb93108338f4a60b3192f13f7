package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_962:String = "PLSV_ADD_SONGS";
      
      public static const const_1183:String = "PLSV_START_PLAYBACK";
      
      public static const const_559:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_44 != const_559)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_441[this.var_44];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_441[const_962];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_441.add(const_559,_loc1_);
