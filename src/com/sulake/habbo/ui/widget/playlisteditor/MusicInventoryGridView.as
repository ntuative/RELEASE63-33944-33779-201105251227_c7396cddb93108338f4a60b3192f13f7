package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_103:MusicInventoryGridItem;
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_627.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_103.playButtonState = MusicInventoryGridItem.const_1237;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_103 != null)
         {
            this.var_103.playButtonState = MusicInventoryGridItem.const_505;
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            if(param2.name == "button_to_playlist" || _loc3_)
            {
               if(this.var_103 != null)
               {
                  this.var_103.deselect();
                  this.stopPreview();
                  this._widget.sendAddToPlayListMessage(this.var_103.diskId);
                  this.var_103 = null;
               }
            }
            else if(param2.name == "button_play_pause")
            {
               if(this.var_103.playButtonState == MusicInventoryGridItem.const_505)
               {
                  this.var_103.playButtonState = MusicInventoryGridItem.const_1288;
                  this._widget.playUserSong(this.var_103.songId);
               }
               else
               {
                  this.stopPreview();
            ...
            {
               _loc4_ = this.var_627.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
                  _loc5_ = this._items.getWithIndex(_loc4_);
                  if(_loc5_ != this.var_103)
                  {
                     if(this.var_103 != null)
                     {
                        this.var_103.deselect();
