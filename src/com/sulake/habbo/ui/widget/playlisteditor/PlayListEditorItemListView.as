package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListEditorItemListView
   {
      ...
      private var var_103:PlayListEditorItem;
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(this.var_1180 >= 0 && this.var_1180 < this._items.length)
         {
            _loc2_ = this._items[this.var_1180] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_571);
         }
         _loc2_ = this._items[param1] as PlayListEditorItem;
         _loc2_.setIconState(PlayListEditorItem.const_1310);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            if(param2.name == "button_remove_from_playlist" || _loc3_)
            {
               ...
               if(this.var_963 > -1)
               {
                  this._widget.sendRemoveFromPlayListMessage(this.var_963);
               }
               this.var_103 = null;
               this.var_963 = -1;
            }
            else
            {
               ...
               {
                  this.var_963 = _loc4_;
                  this.var_103 = this._items[_loc4_];
                  this.var_103.select();
