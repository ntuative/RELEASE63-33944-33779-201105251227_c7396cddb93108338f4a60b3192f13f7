package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1607:int = 250;
      
      private static const const_1608:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1609:String = "${widgets.chatinput.say}";
      ...
      private var var_2100:IWindow;
      
      private var _button:IWindow;
      
      private var var_2101:IWindow;
      
      private var var_1613:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1340 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2901 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2902 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_402 = new Timer(1000,1);
         this.var_402.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_473 = new Timer(10000,1);
         this.var_473.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_402.reset();
            this.var_402.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_402 = null;
         }
         if(this.var_473 != null)
         {
            this.var_473.reset();
            this.var_473.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_473 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2100 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_2101 = this._window.findChildByName("send_button_text");
         this.var_1613 = this._window.findChildByName("block_text");
         this.var_2101.caption = const_1609;
         ...
         this.var_26.addEventListener(WindowKeyboardEvent.const_215,this.windowKeyEventProcessor);
         this.var_26.addEventListener(WindowKeyboardEvent.const_324,this.keyUpHandler);
         ...
         this.var_1614 = true;
         this.var_693 = "";
         this._window.addEventListener(WindowEvent.const_765,this.updatePosition);
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_2100.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1607 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1608);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_26 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1340 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_26.text = "";
                  this.var_693 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_693.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_692);
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         if(this._widget != null)
         {
            if(this.var_402.running)
            {
               this.var_402.reset();
            }
            if(this.var_473.running)
            {
               this.var_473.reset();
            }
