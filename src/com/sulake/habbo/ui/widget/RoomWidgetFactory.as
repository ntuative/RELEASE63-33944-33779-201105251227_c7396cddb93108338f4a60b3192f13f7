      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_419:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_64,this.var_144,this.var_2909++,this,this._questEngine);
               break;
            case RoomWidgetEnum.const_412:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_64,this.var_144,this);
               break;
            case RoomWidgetEnum.const_611:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_64,this.var_144,this._catalog);
               break;
            case RoomWidgetEnum.const_525:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_64,events,this.var_144);
               break;
            ...
            case RoomWidgetEnum.const_494:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_64,this.var_144,this.var_13);
               break;
            ...
            case RoomWidgetEnum.const_512:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_64,this.var_144);
               break;
            case RoomWidgetEnum.const_878:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_64,this.var_144);
               break;
            case RoomWidgetEnum.const_125:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_64,this.var_144);
               break;
            ...
            case RoomWidgetEnum.const_124:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_144,this.var_64,this);
               break;
            ...
            case RoomWidgetEnum.const_528:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_64,this.var_144,this._catalog);
               break;
