package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1040:MeMenuSoundSettingsSlider;
      ...
      private var var_1039:BitmapData;
      ...
      {
         this.var_958 = param1.volume;
         if(this.var_1040 != null)
         {
            this.var_1040.setValue(this.var_958);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1038 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1037 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1039 = (_loc5_.content as BitmapData).clone();
         }
         this.var_1040 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_958 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1039);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1038);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1036);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1037);
         }
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               this._widget.changeView(MeMenuWidget.const_930);
               break;
            default:
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_903);
         }
