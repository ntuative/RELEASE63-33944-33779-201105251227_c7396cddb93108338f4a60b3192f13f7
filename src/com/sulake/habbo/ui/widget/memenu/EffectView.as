package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2245:int = 1000;
      ...
      private var var_1042:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_210 = new Timer(this.const_2245);
         this.var_210.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_210.stop();
            this.var_210.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_210 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_190.isActive)
         {
            ...
            this.var_1043.width = _loc2_ * this.var_313;
         }
         else
         {
            this.var_1043.width = 0;
            this.var_210.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_844 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_844 == null)
            {
               return;
            }
         ...
         if(!this.var_190.isActive)
         {
            this.var_844.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_844.caption = "${widgets.memenu.effects.active.timeleft}";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _loc2_ = this._container.method_4.assets.getAssetByName(_loc3_) as XmlAsset;
         this._window = this._container.method_4.windowManager.buildFromXML(_loc2_.content as XML) as IWindowContainer;
         if(this._window == null)
         {
         ...
         else
         {
            ...
            this.var_1042 = this._window.findChildByName("effect_hilite");
            this.var_1042.visible = false;
         }
         this.setTimeLeft();
         this.var_1043 = this._window.findChildByName("loader_bar");
         if(this.var_1043 != null)
         {
            this.var_313 = this.var_1043.width;
            this.var_210.start();
            this.onUpdate();
         }
      ...
      {
         var _loc3_:BitmapDataAsset = this._container.method_4.assets.getAssetByName(param2) as BitmapDataAsset;
