package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_181:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_192 && this._localization && this._friendList && this.var_921 && this._soundManager)
         {
            unlock();
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_181 = new MessengerView(this);
      ...
      public function startConversation(param1:int) : void
      {
         ...
         else
         {
            ...
            this.var_181.openMessenger();
            this.var_181.refresh();
         }
      }
      ...
      public function playSendSound() : void
      {
         ...
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1137);
         }
      }
      
      public function isOpen() : Boolean
      {
         return this.var_181 && this.var_181.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_181)
         {
            if(this.var_181.isMessengerOpen())
            {
               this.var_181.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_688,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1283,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function addMsg(param1:Message) : void
      {
         ...
         if(!this.var_181.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
               this._soundManager.playSound(HabboSoundTypesEnum.const_1231);
            }
         }
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1135,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
