package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_995:ConversationsTabView;
      
      private var var_949:ITextFieldWindow;
      
      private var var_17:IFrameWindow;
      
      private var var_1521:ConversationView;
      ...
      public function refresh() : void
      {
         ...
         this.var_995.refresh();
         this.var_1521.refresh();
         if(this.var_136.conversations.openConversations.length < 1)
         {
            this.var_17.visible = false;
         }
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1521.addMessage(param2);
      }
      
      private function prepareContent() : void
      {
         this.var_17 = IFrameWindow(this.var_136.getXmlWindow("main_window"));
         ...
         this.var_995 = new ConversationsTabView(this.var_136,this.var_17);
         this.var_995.refresh();
         this.var_949 = ITextFieldWindow(this.var_17.findChildByName("message_input"));
         this.var_949.addEventListener(WindowKeyboardEvent.const_215,this.onMessageInput);
         this.var_1521 = new ConversationView(this.var_136,this.var_17);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_713,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1119,true);
         this.var_17.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc2_ = 120;
            _loc3_ = this.var_949.text;
            if(_loc3_.length > _loc2_)
            {
               this.var_949.text = _loc3_.substring(0,_loc2_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_949.text;
         ...
         this.var_949.text = "";
         this.var_136.conversations.addMessageAndUpdateView(new Message(Message.const_888,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_995 == null ? 7 : int(this.var_995.getTabCount());
      }
   }
}
