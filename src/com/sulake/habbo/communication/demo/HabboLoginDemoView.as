package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_579:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_160.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_150,HabboWindowStyle.const_48,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1952,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1952,"/");
         ...
         {
            dispatchEvent(new Event(const_579));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_141.removeEventListener(SSOTicket.const_407,this.onParsedTicketSuccess);
            this.var_141.removeEventListener(SSOTicket.const_314,this.onParsedTicketFailure);
            this.var_141 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_141 = new SSOTicket(this.var_160.assets,_loc3_,_loc2_,param1);
         this.var_141.addEventListener(SSOTicket.const_407,this.onParsedTicketSuccess);
         this.var_141.addEventListener(SSOTicket.const_314,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_160.flashClientUrl = this.var_141.flashClientUrl;
         this.var_160.ssoTicket = this.var_141.ticket;
         this.var_141.removeEventListener(SSOTicket.const_407,this.onParsedTicketSuccess);
         this.var_141.removeEventListener(SSOTicket.const_314,this.onParsedTicketFailure);
         this.var_141 = null;
         dispatchEvent(new Event(const_579));
