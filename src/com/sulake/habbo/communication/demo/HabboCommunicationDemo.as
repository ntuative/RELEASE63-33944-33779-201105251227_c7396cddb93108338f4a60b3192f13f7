package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2732:PseudoRandom;
      ...
      private var var_239:HabboHotelView;
      
      private var var_1549:String = "";
      
      private const const_1952:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_653 = param1;
            this.var_54.initConnection(HabboConnectionType.const_265);
         }
      }
      ...
      {
         if(this.var_54 && this.var_144 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_239 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         ...
         {
            this.var_239.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_144.getKey("use.sso.ticket") == "1";
         this.var_653 = this.var_144.getKey("sso.ticket",null);
         this.var_1971 = this.var_144.getKey("flash.client.url","");
         this.var_2731 = this.var_144.getKey("external.variables.txt","");
         if(this.var_239 == null)
         {
            this.var_239 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_54.mode = HabboConnectionType.const_98;
            if(this.var_653)
            {
               this.var_54.initConnection(HabboConnectionType.const_265);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_579,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1773);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_54.mode = HabboConnectionType.const_1195;
            }
         }
         this.var_54.initConnection(HabboConnectionType.const_265);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_769);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2732 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_54.mode)
         {
            case HabboConnectionType.const_98:
               ...
               this.var_1549 = _loc4_;
               this.var_239.loadBannerImage(_loc7_ + "?token=" + this.var_1549,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1195:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1722:
               this.var_1025 = this.generateRandomHexString(30);
               this.var_538 = new DiffieHellman(new BigInteger(this.var_144.getKey("connection.development.prime"),16),new BigInteger(this.var_144.getKey("connection.development.generator"),16));
               this.var_538.init(this.var_1025);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2732);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1971,this.var_2731));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1952,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_653 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_653);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2730)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1549);
