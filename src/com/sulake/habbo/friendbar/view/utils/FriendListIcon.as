package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class FriendListIcon extends Icon
   {
      ...
      override public function notify(param1:Boolean) : void
      {
         super.notify(param1);
         this.enable(param1);
         toggleTimer(param1 || _hover,!!_hover ? int(const_1093) : int(const_1092));
         if(!var_885 && !_hover)
         {
      ...
      {
         super.hover(param1);
         toggleTimer(param1 || var_885,!!_hover ? int(const_1093) : int(const_1092));
         if(!var_885 && !_hover)
         {
            image = this._assets.getAssetByName("icon_friendlist_png") as BitmapDataAsset;
         }
