package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_675:String = "Navigation";
      
      private static const const_676:String = "Friend Bar";
      
      private static const const_1564:String = "go.friendbar";
      
      private static const const_1562:String = "chat_btn_click";
      
      private static const const_1566:String = "find_friends_btn_click";
      
      private static const const_1086:String = "Toolbar";
      
      private static const const_1085:String = "open";
      
      private static const const_1084:String = "close";
      
      private static const const_1565:String = "FRIENDLIST";
      
      private static const const_1563:String = "MESSENGER";
       
      
      private var var_92:IHabboCommunicationManager;
      
      private var var_326:IHabboFriendList;
      
      private var var_460:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_326)
            {
               this.var_326.release(new IIDHabboFriendList());
               this.var_326 = null;
            }
            if(this.var_460)
            {
               this.var_460.release(new IIDHabboMessenger());
               this.var_460 = null;
            }
            this.var_148 = null;
      ...
      {
         return this.var_148[param1];
      }
      
      public function getFriendByID(param1:int) : IFriendEntity
      {
         return this.var_325.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_92)
         {
            ...
            this.var_92.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_675,const_676,const_1564));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_460)
         {
            this.var_460.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false));
            if(this.var_92)
            {
               this.var_92.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_675,const_676,const_1562));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_92)
         {
            ...
            this.var_92.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_675,const_676,const_1566));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_326)
         {
            if(!this.var_326.disposed)
            {
               if(!this.var_326.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_326.openFriendRequests();
                  }
                  else
                  {
                     this.var_326.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_326.mainWindow;
               ...
               if(this.var_92)
               {
                  this.var_92.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1086,const_1565,!!this.var_326.isOpen() ? const_1085 : const_1084));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_460)
         {
            if(!this.var_460.disposed)
            {
               this.var_460.toggleMessenger();
               if(this.var_92)
               {
                  this.var_92.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1086,const_1563,!!this.var_460.isOpen() ? const_1085 : const_1084));
               }
            }
         }
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_325.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_325.remove(_loc8_);
               this.var_148.splice(this.var_148.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_325.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_300)
            {
               ...
               this.var_148.push(_loc3_);
               this.var_325.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_300)
            {
               if(this.var_325.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
                  this.var_148.push(_loc3_);
                  this.var_325.add(_loc3_.id,_loc3_);
         ...
         {
            this.var_148 = !!const_300 ? this.sortByNameAndOnlineStatus(this.var_148) : this.sortByName(this.var_148);
         }
