package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_534:int = 70;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1701 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1701 = 15;
         }
         this.var_1703 = this._window.height;
         this.var_1417 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_622:
               ...
               _loc2_ = Number(this.var_1132) / Number(this.var_916["time_fade_in"]);
               if(this.var_1132 > int(this.var_916["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1001:
               ...
               if(this.var_1418 > int(this.var_916["time_display"]) && !this.var_1702)
               {
                  this.startFadeOut();
               }
               break;
            case const_1002:
               ...
               _loc3_ = 1 - Number(this.var_1133) / Number(this.var_916["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1133 > int(this.var_916["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1701;
         if(this._window.height < this.var_1703)
         {
            this._window.height = this.var_1703;
         }
      }
      ...
      {
         this.var_1133 = 0;
         this._state = const_1002;
      }
      
      private function startDisplay() : void
      {
         this.var_1418 = 0;
         this._state = const_1001;
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1861;
         this._window.y = this.var_1417;
      }
