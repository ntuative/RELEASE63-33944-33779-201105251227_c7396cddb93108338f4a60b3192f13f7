package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1946:String = "badge_bg_001_png";
      
      private const const_2213:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         param13.events.addEventListener(BadgeImageReadyEvent.const_110,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2280 = this.var_64.getBadgeName(this.var_295);
         this.var_2279 = this.var_64.getBadgeDesc(this.var_295);
         this.var_2281 = this.var_64.getAchievementNameForFacebook(this.var_295,this.var_377.userName,this.var_377.realName,this.var_1150);
         this.var_2283 = this.var_64.getAchievementDescForFacebook(this.var_295,this.var_377.userName,this.var_377.realName,this.var_1150);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2278 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_64.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1942.toString());
         this.var_64.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1416.toString());
         this.var_64.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1416.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1698;
         var _loc17_:String = this.var_1698 == 0 ? "pixels" : "activitypoints";
         this.var_64.registerParameter(_loc16_,_loc17_,"" + this.var_2284);
         _loc15_.caption = this.var_64.getKey(_loc16_);
         this._window.findChildByName("achievement_info").caption = this._desc;
         this.setBadge(param13.getBadgeImage(param1),this.const_1946);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2213) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1416 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_295,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_295,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_295,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_64.registerParameter(param1,"badge_name",this.var_2280);
         this.var_64.registerParameter(param1,"badge_desc",this.var_2279);
         this.var_64.registerParameter(param1,"badge_name_fb",this.var_2281);
         this.var_64.registerParameter(param1,"badge_desc_fb",this.var_2283);
         this.var_64.registerParameter(param1,"level",this.var_1150.toString());
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_295)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1946);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_295,this._feedTitleFb,this.var_2278,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2282));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_295,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_295,"client.skip_post"));
               this.dispose();
               return;
         }
      }
