package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1186:BitmapData = null;
      
      private var var_1188:BitmapData = null;
      ...
      {
         this.var_256 = param2 as IHabboCommunicationManager;
         if(this.var_256 == null)
         {
            return;
         }
         this._connection = this.var_256.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2545 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2544 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2542 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1828 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1187 == 0)
         {
            this.var_1187 = getTimer();
            return false;
         }
         if(this.var_1828 > 0 && this.var_1827 >= this.var_1828)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1187;
         if(_loc1_ > this.var_2544)
         {
            ++this.var_1827;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1475 = _loc2_.imageUrl;
         this.var_2543 = _loc2_.clickUrl;
         this.var_1187 = getTimer();
         if(this.var_1475 != "")
         {
            _loc3_ = this.var_1475;
            ...
            {
               this.var_231 = new Timer(this.var_2542,1);
            ...
            this.var_231.start();
            _loc4_ = new URLRequest(this.var_1475);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_496,0,0,param1.bitmapData,this.var_2543));
            this.var_1187 = getTimer();
         }
         else
         {
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1829 = _loc2_.clickUrl;
         if(this.var_1474 != "" && this.var_1829 != "")
         {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_588,0,0,_loc4_,_loc2_.assetName,this.var_1829,this.var_1186,this.var_1188));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1186 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1188 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_614.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_614.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_46,this.onBillboardImageLoadError);
      }
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_614.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_905,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_614.remove(_loc2_.assetName);
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_917,_loc4_.roomId,0,null,_loc4_.imageUrl,_loc4_.clickUrl,null,null,_loc4_.objectId));
         }
      }
   }
}
