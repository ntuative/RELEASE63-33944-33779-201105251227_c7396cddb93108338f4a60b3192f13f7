package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1579:uint = 12247545;
      
      private static const const_1581:String = "HELP";
      
      private static const const_1578:String = "ROOMINFO";
      ...
      private var var_343:IWindow;
      
      private var var_687:IWindowContainer;
      
      private const const_932:int = 41;
      ...
      public function ToolbarExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_343 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_58.removeListItem(this.var_343);
      }
      
      public function showRoomInfo() : void
      {
         this.var_58.addListItemAt(this.var_343,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_885;
         _loc3_.y = this.const_932;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_687)
         {
            this.var_687 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1581);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1578);
               break;
            case "confirm":
               if(false)
               {
