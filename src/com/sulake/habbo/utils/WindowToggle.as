package com.sulake.habbo.utils
{
   ...
   public class WindowToggle implements IDisposable
   {
      ...
      public static const const_1831:int = 1;
      
      public static const const_1276:int = 2;
      ...
      public function show() : void
      {
         ...
         {
            if(this._window.parent != this.var_1083)
            {
               this.var_1083.addChild(this._window);
            }
