package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_934:Number = 64;
      
      public static const const_1313:Number = 32;
      ...
      private var var_2059:Number = 1.0;
      ...
      private var var_2976:Number = -500.0;
      
      private var var_2977:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2061 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_469.assign(this.var_98);
         this.var_469.x *= this.var_470;
         this.var_469.y *= this.var_468;
         this.var_469.z *= this.var_471;
         return this.var_469;
      }
      ...
      {
         if(this.var_470 != param1 * this.var_2060)
         {
            this.var_470 = param1 * this.var_2060;
            ++this.var_171;
         }
      }
      ...
      {
         if(this.var_468 != param1 * this.var_2059)
         {
            this.var_468 = param1 * this.var_2059;
            ++this.var_171;
         }
      }
      ...
      {
         if(this.var_471 != param1 * this.var_2061)
         {
            this.var_471 = param1 * this.var_2061;
            ++this.var_171;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_98.x /= this.var_470;
         this.var_98.y /= this.var_468;
         this.var_98.z /= this.var_471;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_467.x;
         var _loc3_:Number = this.var_467.y;
         var _loc4_:Number = this.var_467.z;
         this.var_467.assign(param1);
         this._direction.assign(param1);
         if(this.var_467.x != _loc2_ || this.var_467.y != _loc3_ || this.var_467.z != _loc4_)
         {
            ++this.var_171;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_162.assign(_loc24_);
            this.var_163.assign(_loc25_);
            this.var_1316.assign(this.var_163);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_162.assign(_loc19_);
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1317.assign(_loc22_);
         }
         else
         {
            this.var_1317.assign(_loc17_);
         }
         ++this.var_171;
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_162);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_468;
         _loc2_.z *= this.var_471;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1317);
         if(_loc3_ < this.var_2976 || _loc3_ > this.var_2977)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_162);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_468;
            _loc2_.z *= this.var_471;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1317);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_162,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_98.x * this.var_470,this.var_98.y * this.var_468,this.var_98.z * this.var_471);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_163;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_470,param2.y * this.var_468,param2.z * this.var_471);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_470,param3.y * this.var_468,param3.z * this.var_471);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_470,param4.y * this.var_468,param4.z * this.var_471);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1313;
         }
         else
         {
            this.scale = const_934;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_934;
      }
