package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_924 = param1 * 1024 * 1024;
         this.var_1738 = param2 * 1024 * 1024;
         this.var_1432 = param3 * 1024 * 1024;
         if(this.var_1432 < 0)
         {
            this.var_1432 = 0;
         }
      ...
      {
         this.var_924 += this.var_1432;
         if(this.var_924 > this.var_1738)
         {
            this.var_924 = this.var_1738;
         }
      }
