package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1740 || param1.getUpdateID() != this.var_2383)
         {
            this.var_2383 = param1.getUpdateID();
            if(param2.updateId != this.var_1740 || _loc4_.x != this.var_1151.x || _loc4_.y != this.var_1151.y || _loc4_.z != this.var_1151.z)
            {
               this.var_1740 = param2.updateId;
               this.var_1151.assign(_loc4_);
               _loc3_ = true;
            }
         }
         ...
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_354.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_354.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_354.x = Math.round(this.var_354.x);
            this.var_354.y = Math.round(this.var_354.y);
         }
         return this.var_354;
      }
   }
