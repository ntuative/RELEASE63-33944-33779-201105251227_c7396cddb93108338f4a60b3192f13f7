package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1454:int = 128;
      
      private var var_1453:Boolean = false;
      
      private var var_2956:Point;
      ...
      {
         if(param1 != this.var_1776 || param2 != this.var_1775)
         {
      ...
      {
         if(this.var_1454 > 255 || bitmapData == null)
         {
            return false;
         }
