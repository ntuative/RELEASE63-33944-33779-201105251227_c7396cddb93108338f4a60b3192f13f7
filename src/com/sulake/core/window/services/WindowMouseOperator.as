package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_710:Point;
      
      protected var var_1466:uint;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_710);
         this._window.offset(this.var_710.x - this._offset.x,this.var_710.y - this._offset.y);
      }
