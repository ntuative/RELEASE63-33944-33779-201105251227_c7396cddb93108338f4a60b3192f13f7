         ...
         if(_working && true)
         {
            if(this.var_1333.indexOf(param1.type) >= 0)
            {
               if(param1 is WindowMouseEvent)
               {
                  ...
                  if(this.var_1334 == MouseListenerType.const_1881 && !_loc2_)
                  {
                     return;
                  }
                  if(this.var_1334 == MouseListenerType.const_1245 && _loc2_)
                  {
                     return;
                  }
               }
