package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1617:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1616:Class = ProfilerOutput_profiler_task_xml;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2983 = new Array();
         this.var_174 = this.profiler;
         this._windowManager = param2;
         this.var_943 = param3;
         var _loc4_:ByteArray = new var_1617() as ByteArray;
      ...
      {
         var _loc2_:ByteArray = new var_1616() as ByteArray;
