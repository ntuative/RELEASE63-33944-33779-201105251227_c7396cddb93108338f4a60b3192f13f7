package com.sulake.core.window.utils
{
   ...
   public class GenericEventQueue implements IEventQueue, IDisposable
   {
      ...
      {
         var _loc1_:* = null;
         if(this._index < this.var_482.length)
         {
            _loc1_ = this.var_482[this._index];
            ++this._index;
         }
         return _loc1_;
      }
      ...
      {
         this.var_482.splice(this._index - 1,1);
         if(this._index > 0)
         {
            --this._index;
         }
      ...
      {
         this.var_482.splice(0,this.var_482.length);
         this._index = 0;
      }
