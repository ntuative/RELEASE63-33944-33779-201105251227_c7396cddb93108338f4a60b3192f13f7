package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_1513:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_91[const_214],var_91[ITALIC],var_91[BOLD]];
            var_91.reset();
            var_91[const_214] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         if(countSubStrings(param1,const_671) != countSubStrings(param1,const_670))
         {
            throw new Error("Mismatching amount of \"" + const_671 + "\" versus \"" + const_670 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1512) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1513) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_671)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
