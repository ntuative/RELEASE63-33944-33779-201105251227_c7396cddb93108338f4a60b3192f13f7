package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1160:String = "_EXCLUDE";
      
      public static const const_2048:String = "_INCLUDE";
      
      public static const const_2112:String = "_TEMP";
      
      private static const const_1415:String = "layout";
      
      private static const const_1023:String = "window";
      
      private static const const_1022:String = "variables";
      
      private static const const_1024:String = "filters";
      
      private static const const_457:String = "name";
      
      private static const const_1407:String = "style";
      
      private static const const_650:String = "params";
      ...
      private static const const_1414:String = "visible";
      
      private static const const_1408:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1323:String = "blend";
      
      private static const const_1412:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1405:String = "treshold";
      
      private static const const_1418:String = "children";
      
      private static const const_1409:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1411:String = "height_min";
      
      private static const const_1416:String = "height_max";
      
      private static const const_651:String = "true";
      
      private static const const_172:String = "0";
      ...
      protected var var_1356:Dictionary;
      
      protected var var_1355:Dictionary;
      
      protected var var_1094:Dictionary;
      
      protected var var_1633:Dictionary;
      
      protected var var_2160:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1356,this.var_1355);
         this.var_1094 = new Dictionary();
         this.var_1633 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1094,this.var_1633);
         this.var_2160 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1417,const_51);
         return param1.replace(const_1406,const_51);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1356)
            {
               delete this.var_1356[_loc1_];
            }
            for(_loc1_ in this.var_1355)
            {
               delete this.var_1355[_loc1_];
            }
            for(_loc1_ in this.var_1094)
            {
               delete this.var_1094[_loc1_];
            }
            for(_loc1_ in this.var_1633)
            {
               delete this.var_1633[_loc1_];
            }
            this.var_2160.dispose();
            this.var_2160 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1415)
         {
            _loc8_ = param1.child(const_1022);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1024).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1023);
         ...
         if(param1.localName() == const_1023)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1356[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_457,variables,"")));
         style = uint(this.parseAttribute(xml,const_1407,variables,style));
         params = uint(this.parseAttribute(xml,const_650,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1410,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_172));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_172));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_172));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_172));
         visible = this.parseAttribute(xml,const_1414,variables,visible.toString()) == const_651;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_650).length() > 0)
         {
            list = xml.child(const_650).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_457,variables,"") as String;
               if(this.var_1094[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_457)) + "\"!");
               }
               params |= this.var_1094[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_51) : const_51;
         caption = unescape(String(this.parseAttribute(xml,const_1408,variables,caption)));
         if(tag != const_51)
         {
            tags = tag.split(const_1389);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1022)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1409,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1411,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1416,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_651;
         blend = Number(this.parseAttribute(xml,const_1323,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1412,variables,window.clipping.toString()) == const_651;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1405,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1024).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_51;
         var _loc3_:String = this.var_1355[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1160) == -1)
                  {
