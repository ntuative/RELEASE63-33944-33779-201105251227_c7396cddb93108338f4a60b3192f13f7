package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1544:String = "skin";
      
      private static const const_1547:String = "bitmap";
      
      private static const const_1543:String = "fill";
      
      private static const const_1546:String = "text";
      
      private static const const_1545:String = "label";
      
      private static const const_1548:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "MessengerView";
      ...
      private var var_2792:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_2022,this.var_2793);
         this.var_2792 = new Dictionary();
         this.var_2791 = new Dictionary();
         StateCodeTable.fillTables(this.var_2792,this.var_2791);
         this.var_458 = new Dictionary();
         this.var_458[const_1544] = BitmapSkinRenderer;
         this.var_458[const_1547] = BitmapDataRenderer;
         this.var_458[const_1543] = FillSkinRenderer;
         this.var_458[const_1546] = TextSkinRenderer;
         this.var_458[const_1545] = LabelRenderer;
         this.var_458[const_1548] = ShapeSkinRenderer;
         this.var_458[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_458[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_340 == null)
         {
            var_340 = new Array();
            var_340.push(WindowState.const_69);
            var_340.push(WindowState.const_88);
            var_340.push(WindowState.const_96);
            var_340.push(WindowState.const_58);
            var_340.push(WindowState.const_86);
            var_340.push(WindowState.const_85);
            var_340.push(WindowState.const_89);
            var_340.push(WindowState.const_103);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2924 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2022[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1045[param1] == null)
         {
            this.var_1045[param1] = new Array(const_1081);
         }
         this.var_1045[param1][param2] = param3;
         if(this.var_1044[param1] == null)
         {
            this.var_1044[param1] = new Array(const_1081);
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1045[param1];
         if(_loc3_)
         {
