package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinLayout extends ChildEntityArray implements ISkinLayout
   {
      ...
      protected var var_269:uint;
      
      protected var _height:uint;
      
      protected var var_1927:String;
      
      protected var var_2932:Boolean;
      ...
      public function isFixedWidth() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(SkinLayoutEntity(getChildAt(_loc2_)).var_334 != SkinLayoutEntity.const_476)
            {
               return false;
            }
            _loc2_++;
      ...
      public function isFixedHeight() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(SkinLayoutEntity(getChildAt(_loc2_)).var_332 != SkinLayoutEntity.const_476)
            {
               return false;
            }
            _loc2_++;
      ...
      override public function addChild(param1:IChildEntity) : IChildEntity
      {
         ...
         this.var_269 = _loc2_.region.right > this.var_269 ? uint(_loc2_.region.right) : uint(this.var_269);
      ...
      override public function addChildAt(param1:IChildEntity, param2:int) : IChildEntity
      {
         ...
         this.var_269 = _loc3_.region.right > this.var_269 ? uint(_loc3_.region.right) : uint(this.var_269);
      ...
      override public function removeChild(param1:IChildEntity) : IChildEntity
      {
         ...
         this.var_269 = this.calculateWidth();
