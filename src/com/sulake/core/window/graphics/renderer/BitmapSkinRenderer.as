package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_881:Dictionary;
      
      protected var var_882:Dictionary;
      ...
      {
         super(param1);
         this.var_881 = new Dictionary(false);
         this.var_882 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_268 = null;
            this.var_797 = null;
            for(_loc1_ in this.var_881)
            {
               _loc2_ = this.var_881[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_881[_loc1_];
            }
            this.var_881 = null;
            for(_loc1_ in this.var_882)
            {
               _loc2_ = this.var_882[_loc1_] as BitmapData;
               _loc2_.dispose();
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_797.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_797.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_797.blueMultiplier = (param1.color & 255) / 255;
               this.var_797.alphaMultiplier = 1;
            }
            _loc17_ = 0;
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_797);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_334 == SkinLayoutEntity.const_346)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_334 == SkinLayoutEntity.const_515)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_334 == SkinLayoutEntity.const_318)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_334 == SkinLayoutEntity.const_483)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_332 == SkinLayoutEntity.const_346)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_515)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_318)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_483)
                  {
                  ...
                  else if(_loc10_.var_332 == SkinLayoutEntity.const_318 || _loc10_.var_334 == SkinLayoutEntity.const_318)
                  {
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_334 == SkinLayoutEntity.const_346)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_332 == SkinLayoutEntity.const_346)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_881[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_882[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
