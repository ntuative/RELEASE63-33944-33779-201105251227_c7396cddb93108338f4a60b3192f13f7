   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_334 = SkinLayoutEntity.const_476;
                  break;
               case "move":
                  _loc5_.var_334 = SkinLayoutEntity.const_346;
                  break;
               case "strech":
                  _loc5_.var_334 = SkinLayoutEntity.const_515;
                  break;
               case "tiled":
                  _loc5_.var_334 = SkinLayoutEntity.const_318;
                  break;
               case "center":
                  _loc5_.var_334 = SkinLayoutEntity.const_483;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_332 = SkinLayoutEntity.const_476;
                  break;
               case "move":
                  _loc5_.var_332 = SkinLayoutEntity.const_346;
                  break;
               case "strech":
                  _loc5_.var_332 = SkinLayoutEntity.const_515;
                  break;
               case "tiled":
                  _loc5_.var_332 = SkinLayoutEntity.const_318;
                  break;
               case "center":
                  _loc5_.var_332 = SkinLayoutEntity.const_483;
            }
         }
