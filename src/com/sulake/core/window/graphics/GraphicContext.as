package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1837:uint = 0;
      
      public static const const_842:uint = 1;
      
      public static const const_1100:uint = 2;
      
      public static const const_720:uint = 4;
      
      public static const const_1780:uint = 8;
      
      public static const const_1651:uint = 16;
      
      public static const const_2021:uint = 64;
      
      public static const const_2187:uint = 128;
      
      public static const const_1146:uint = 256;
      
      protected static var var_578:uint = 0;
      
      protected static var var_339:uint = 0;
         ...
         if(this.var_878)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_339 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2157,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2157,16777215);
                  }
                  var_339 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_878)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_339 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
