package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1344:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_883:Number;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_729 ? true : null;
         }
      ...
      {
         this.var_883 = param1;
         this._field.scrollH = this.var_883 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_883 * this.maxScrollH,this.var_573 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_838,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1191));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1294 ? new PropertyStruct(PropertyDefaults.const_837,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1233) : PropertyDefaults.const_1634);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_281,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1114 ? new PropertyStruct(PropertyDefaults.const_1340,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1253) : PropertyDefaults.const_1700);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_796) ? new PropertyStruct(PropertyDefaults.const_376,this._field.textColor,PropertyStruct.const_157,true) : PropertyDefaults.const_1256);
         ...
         _loc1_.push(this.var_42.left != PropertyDefaults.const_911 ? new PropertyStruct(PropertyDefaults.const_250,this.var_42.left,PropertyStruct.const_41,true) : PropertyDefaults.const_751);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_961 ? new PropertyStruct(PropertyDefaults.const_243,this.var_42.top,PropertyStruct.const_41,true) : PropertyDefaults.const_932);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_810 ? new PropertyStruct(PropertyDefaults.const_288,this.var_42.right,PropertyStruct.const_41,true) : PropertyDefaults.const_885);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_840 ? new PropertyStruct(PropertyDefaults.const_283,this.var_42.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_896);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1155 ? new PropertyStruct(PropertyDefaults.const_753,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1699);
