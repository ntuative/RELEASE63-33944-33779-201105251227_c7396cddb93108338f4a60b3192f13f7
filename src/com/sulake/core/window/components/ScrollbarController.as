package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1508:String = "increment";
      
      private static const const_1507:String = "decrement";
      
      private static const const_1074:String = "slider_track";
      
      private static const const_669:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_707:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_19 != null && !this.var_19.disposed)
         {
            ...
            this.var_19.removeEventListener(WindowEvent.const_463,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_40,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_463,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         else if(this.var_1011 != null)
         {
            _loc2_ = this.var_1011;
         }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1011 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1074) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_669) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_669:
         ...
         if(param2.type == WindowEvent.const_623)
         {
            if(this.var_19 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_353)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_707;
                  }
                  else
                  {
                     this.scrollV -= this.var_707;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_894)
         {
            if(param2.name == const_1508)
            {
               if(this.var_19)
               {
                  this.var_1255 = true;
            ...
            else if(param2.name == const_1507)
            {
               if(this.var_19)
               {
                  this.var_1255 = true;
            ...
            else if(param2.name == const_1074)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_669).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_353)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1011) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1011) as IScrollableWindow;
               if(_loc1_)
               {
