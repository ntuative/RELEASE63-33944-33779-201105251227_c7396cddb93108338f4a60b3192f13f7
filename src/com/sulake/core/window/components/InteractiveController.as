package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_495)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_495)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_908,param1.toolTipCaption,PropertyStruct.const_53,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1825);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1165)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_912,param1.toolTipDelay,PropertyStruct.const_281,true));
         }
         else
         {
      ...
      {
         this.var_1370 = param1 == null ? "null" : param1;
      }
