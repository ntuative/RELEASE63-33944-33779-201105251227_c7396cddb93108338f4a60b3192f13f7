package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1350:String = "_TITLE";
      
      private static const const_1574:String = "_HEADER";
      
      private static const const_1573:String = "_CONTENT";
      
      private static const const_1572:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1600:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1350) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1600 = findChildByTag(const_1574) as IHeaderWindow;
            if(!this.var_1600)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_195 = findChildByTag(const_1573) as IWindowContainer;
            if(!this.var_195)
            {
      ...
      {
         return findChildByTag(const_1572) as IScalerWindow;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_280);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_250,_loc3_.left,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_243,_loc3_.top,PropertyStruct.const_41,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_288,0 - _loc3_.right,PropertyStruct.const_41,_loc2_));
