package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_1967:String = "_POINTER_UP";
      
      private static const const_1968:String = "_POINTER_DOWN";
      
      private static const const_1966:String = "_POINTER_LEFT";
      
      private static const const_1969:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_835,this._direction,PropertyStruct.const_53,true));
         }
         else
         {
