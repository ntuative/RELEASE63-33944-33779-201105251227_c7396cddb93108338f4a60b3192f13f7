package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1387:String = "_SELECTOR";
      
      private static const const_1386:String = "_CONTENT";
       
      
      protected var var_1093:ITabSelectorWindow;
      
      protected var var_2158:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1093 = findChildByTag(const_1387) as ITabSelectorWindow;
            if(this.var_1093 != null)
            {
      ...
      {
         if(this.var_2158 == null)
         {
            this.var_2158 = findChildByTag(const_1386) as IWindowContainer;
         }
      ...
      {
         return !!this.var_742 ? this.selector.iterator : null;
      }
