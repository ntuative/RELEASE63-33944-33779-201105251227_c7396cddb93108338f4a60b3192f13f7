package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1638:uint = 500;
      
      protected var var_1370:String = "";
      
      protected var var_1358:Boolean = false;
      ...
      {
         this.var_1370 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1100,var_11);
         }
         return var_22;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_742 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_215,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_403,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_324,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_901,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1911);
         _loc1_.push(this.var_1358 != PropertyDefaults.const_1335 ? new PropertyStruct(PropertyDefaults.const_705,this.var_1358,PropertyStruct.const_38,true) : PropertyDefaults.const_1859);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1239 ? new PropertyStruct(PropertyDefaults.const_775,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1818);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1250 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1705);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_705:
                  this.var_1358 = _loc2_.value as Boolean;
                  if(this.var_1358)
                  {
               ...
               case PropertyDefaults.const_901:
                  ...
                  break;
               case PropertyDefaults.const_1300:
