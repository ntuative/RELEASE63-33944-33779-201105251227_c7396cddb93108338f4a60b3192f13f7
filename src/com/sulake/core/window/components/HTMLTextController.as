package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1023:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_1024:String = "default";
      ...
      {
         if(PropertyDefaults.const_702.indexOf(param1) > -1)
         {
      ...
      {
         return this.var_1024 == LinkTarget.const_30 ? defaultLinkTarget : this.var_1024;
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1225)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_1024 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_877,this.var_1024,PropertyStruct.const_53,true,PropertyDefaults.const_702));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_877)
            {
               this.var_1024 = _loc2_.value as String;
               break;
            }
