package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_313)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1173)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_879;
         if(this.var_879 != param1)
         {
            if(this.var_879 != null)
            {
               if(!this.var_879.disposed)
               {
                  this.var_879.deactivate();
               }
            }
            this.var_879 = param1;
