package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1191:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_427)
         {
            this.var_427.removeEventListener(WindowEvent.const_260,this.scrollBarEventProc);
            this.var_427.removeEventListener(WindowEvent.const_245,this.scrollBarEventProc);
            this.var_427 = null;
         }
         if(this.var_1191)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1191)
         {
            this.var_1191 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_427)
         {
            ...
            if(this.var_427)
            {
               this.var_427.addEventListener(WindowEvent.const_260,this.scrollBarEventProc);
               this.var_427.addEventListener(WindowEvent.const_245,this.scrollBarEventProc);
            }
         }
         return this.var_427;
      }
