package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1935:uint = 1;
      
      protected static const const_1938:uint = 2;
      
      protected static const const_1936:uint = 4;
      
      protected static const const_1937:uint = 3;
      ...
      public static const const_1906:int = 2;
      
      private static var var_1022:Array = new Array();
      
      private static var var_827:Array = new Array();
      ...
      protected var var_244:URLRequest;
      
      protected var _manifest:XML;
      
      protected var var_697:Class;
      
      protected var var_484:uint = 0;
      ...
      protected var var_1099:Boolean = false;
      ...
      protected var var_1364:int;
      
      protected var var_1363:int;
      
      protected var var_3008:uint = 0;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_43.load(param1.var_244,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1131)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_827[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_827.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_827.length < const_1906 && false)
            {
               _loc1_ = var_1022.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_827.push(_loc1_);
                  _loc1_.var_43.load(_loc1_.var_244,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_244 ? this.var_244.url : null;
      }
      ...
      {
         return !!this.var_1100 ? uint(this.var_1364 - this.var_2168) : uint(getTimer() - this.var_2168);
      }
      ...
      {
         this.var_244 = param1;
         this._name = parseNameFromUrl(this.var_244.url);
         this.var_1100 = false;
      ...
      {
         if(this.var_1099 && !_disposed)
         {
            this.var_1099 = false;
            if(!this.var_1100 && this.var_244)
            {
               this.var_1364 = -1;
               this.var_2168 = getTimer();
               queue(this);
            }
         }
      }
      ...
      protected function retry() : Boolean
      {
         if(!this.var_1100 && !_disposed && this.var_1363 > 0)
         {
            ...
            this.addRequestCounterToUrlRequest(this.var_244,const_1695 - this.var_1363);
            if(this.var_2943)
            {
               this.var_244.requestHeaders.push(new URLRequestHeader("pragma","no-cache"));
               this.var_244.requestHeaders.push(new URLRequestHeader("Cache-Control","no-cache"));
               this.var_2943 = false;
            }
            --this.var_1363;
            this.var_484 = 0;
            this.var_43.load(this.var_244,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_484 = LibraryLoader.name_4;
         ...
         if(this.var_484 == LibraryLoader.const_1937)
         {
         ...
         if(this.var_484 == LibraryLoader.name_4)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_697 = this.getDefinition(this._name) as Class;
         if(this.var_697 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_244.url + "!");
            }
            return false;
         }
         ...
         try
         {
            xmlClass = this.var_697.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
