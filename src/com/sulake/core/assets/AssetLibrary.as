package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1117:String = "AssetLibraryReady";
      
      public static const const_890:String = "AssetLibraryLoaded";
      
      public static const const_1743:String = "AssetLibraryUnloaded";
      
      public static const const_1718:String = "AssetLibraryLoadError";
      
      private static const const_457:String = "name";
      
      private static const const_1096:String = "asset";
      
      private static const const_1097:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1095:String = "library";
      
      private static var var_331:Dictionary;
      
      private static var var_2107:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_566:uint = 0;
      
      private static var var_1080:Array = new Array();
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_696 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1095);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_457);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1097);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_696 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1080.splice(var_1080.indexOf(this),1);
            --var_566;
            this.var_567 = null;
            this.var_1082 = null;
            this.var_175 = null;
      ...
      {
         if(this.var_696 == param1.url && this.var_1079)
         {
            if(!this.var_1081 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_697);
            }
            this.var_1081 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1117));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_1079 = false;
         this.var_696 = null;
         dispatchEvent(new Event(AssetLibrary.const_1743));
      }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1290,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1321,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_475;
                     this.var_476.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_476.length ? this.getAssetByName(this.var_476[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_175)
         {
            ...
            {
               return this.var_476.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_175[param1] != null || (this.var_697 != null ? this.var_697[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_2107.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_175)
            {
               if(this.var_175[_loc2_] == param1)
               {
                  this.var_476.splice(this.var_476.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_331.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_331[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_331[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_331)
            {
               _loc3_ = AssetTypeDeclaration(var_331[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_331)
            {
               _loc4_ = AssetTypeDeclaration(var_331[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_697 = _loc2_.resource;
         this.var_696 = _loc2_.url;
         if(this.var_1081)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_697);
         }
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1718));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1095);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_457).toString() == param1)
               {
                  _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_696 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_697[param1]);
                  _loc6_ = _loc3_.child(const_1097);
                  if(_loc6_.length())
                  {
