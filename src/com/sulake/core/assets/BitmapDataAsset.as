   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_108 is BitmapDataAsset)
         {
            ...
            this.var_1414 = BitmapDataAsset(this.var_108).var_1414;
            this.var_1415 = BitmapDataAsset(this.var_108).var_1415;
            if(this._bitmap != null)
            {
               this.var_108 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1414 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1415 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
