package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_575:Array;
      
      protected var var_1096:LoaderContext;
      
      protected var var_487:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1096 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_487 = new AssetLibrary("lib-" + this.var_578++);
         this.var_30.push(this.var_487);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1096;
         }
      ...
      {
         return this.var_487.loadFromResource(param1,param2);
      }
      
      public function unload() : void
      {
         while(this.var_575.length > 0)
         {
            (this.var_575.pop() as IAssetLibrary).dispose();
         }
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < this.var_575.length)
            {
               _loc3_ = this.var_575[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  this.var_575.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return this.var_487.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_487.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_487.createAsset(param1,param2);
      }
      ...
      {
         return this.var_487.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_487.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_487.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_30.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_487.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_30.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
