package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1926 = param1.invDigit();
         this.var_1925 = this.var_1926 & 32767;
         this.var_2681 = this.var_1926 >> 15;
         this.var_2683 = 131071;
         this.var_2682 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_172) > 0)
         {
